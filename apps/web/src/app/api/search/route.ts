...
function getSearchIndex(): MiniSearch {
  ...
  const staticPages: SearchDoc[] = [
    ...
    { id: "getting-started", title: "Getting Started", path: "/docs/getting-started", excerpt: "Create your application, get API keys, and make your first call", type: "guide", content: "getting started quickstart application API keys credentials Node.js SDK REST API" },

...
description: ""
type: "sdk"
source: "https://developers.openrainbow.com/doc/sdk/node/lts/guides/Managing_groups"
lastSynced: "2026-02-20T07:12:33.178Z"
---
# Documentation
...
**rainbow\_ongroupcreated**

Fired when a group has been successfully created

**rainbow\_ongroupupdated**

Fired when a modification occurs on a group

**rainbow\_ongroupdeleted**

Fired when a group has been deleted

**rainbow\_onuseraddedingroup**

Fired when a user has been added to a group

**rainbow\_onuserremovedfromgroup**

Fired when a user has been removed from a group
...
The length of the field `name` is between 1 and 255 characters

**Group description**

The length of the field `description` field is between 1 and 255 characters
...
-   [Managing Groups](/docs/sdk/node#name-managing-groups-0)
-   [Preamble](/docs/sdk/node#name-preamble-4)
-   [Creating a new group](/docs/sdk/node#name-creating-a-new-group-14)
-   [Updating the name of a group](/docs/sdk/node#name-updating-the-name-of-a-group-28)
-   [Adding a user to a group](/docs/sdk/node#name-adding-a-user-to-a-group-36)
-   [Querying groups](/docs/sdk/node#name-querying-groups-44)
-   [Removing a user from a group](/docs/sdk/node#name-removing-a-user-from-a-group-55)
-   [Retrieving groups](/docs/sdk/node#name-retrieving-groups-63)
-   [Retrieving favorite groups](/docs/sdk/node#name-retrieving-favorite-groups-71)
-   [Deleting a group](/docs/sdk/node#name-deleting-a-group-79)
-   [Events](/docs/sdk/node#name-events-87)
-   [Groups at a glance](/docs/sdk/node#name-groups-at-a-glance-155)

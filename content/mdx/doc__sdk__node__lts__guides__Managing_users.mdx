...
description: ""
type: "sdk"
source: "https://developers.openrainbow.com/doc/sdk/node/lts/guides/Managing_users"
lastSynced: "2026-02-20T07:12:33.212Z"
---
# Documentation
...
With this right, the SDK can create or invite new users in the company managed and update their information
...
with this right, the SDK can create or invite new users for all companies of the organization and update the users information
...
Send chat message to a recipient

Be searched by others Rainbow users

Receive chat message from a recipient

Be added to the Network of a Rainbow user

Be invited to a Bubble conversation

Create a Bubble

Send chat message to a Bubble

Have owner right in a Bubble

Receive chat message from a Bubble

Leave a Bubble

Call in audio and video call a recipient

Receive Email notification

Receive audio and video call from a recipient

Be associated to a PBX device and monitor it

Receive a file shared by a recipient

Send a file to a recipient

Receive a file shared in a Bubble

Send a file to a Bubble
...
-   [Managing Users and Guests](/docs/sdk/node#name-managing-users-and-guests-0)
-   [Preamble](/docs/sdk/node#name-preamble-4)
-   [Roles and Rights](/docs/sdk/node#name-roles-and-rights-14)
-   [Creating a new Rainbow user account](/docs/sdk/node#name-creating-a-new-rainbow-user-account-97)
-   [Basic user creation](/docs/sdk/node#name-basic-user-creation-104)
-   [Setting a user language](/docs/sdk/node#name-setting-a-user-language-128)
-   [Creating a new Rainbow guest account](/docs/sdk/node#name-creating-a-new-rainbow-guest-account-142)
-   [Usage of Guest accounts](/docs/sdk/node#name-usage-of-guest-accounts-169)
-   [Basic creation](/docs/sdk/node#name-basic-creation-182)
-   [Anonymous guest](/docs/sdk/node#name-anonymous-guest-193)
-   [Additionnal information around Guest usage](/docs/sdk/node#name-additionnal-information-around-guest-usage-204)
-   [Inviting a new user to Rainbow](/docs/sdk/node#name-inviting-a-new-user-to-rainbow-344)
-   [Basic invitation](/docs/sdk/node#name-basic-invitation-351)
-   [Setting the invitation language](/docs/sdk/node#name-setting-the-invitation-language-362)
-   [Adding a custom message](/docs/sdk/node#name-adding-a-custom-message-373)
-   [Updating user information](/docs/sdk/node#name-updating-user-information-381)
-   [Changing the password](/docs/sdk/node#name-changing-the-password-388)
-   [Setting additional information](/docs/sdk/node#name-setting-additional-information-396)
-   [Deleting users](/docs/sdk/node#name-deleting-users-415)

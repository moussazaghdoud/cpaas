...
description: ""
type: "sdk"
source: "https://developers.openrainbow.com/doc/sdk/cli/tutorials/Getting_started"
lastSynced: "2026-02-20T07:12:28.934Z"
---
# Documentation
...
The Alcatel-Lucent Enterprise (ALE) Rainbow CLI application is a powerful command line tool allowing you to connect to the Rainbow platform and perform administrative tasks.
...
Many commands are available once the application is configured and connected to Rainbow. The Rainbow CLI is designed to perform a lot of Rainbow administrative tasks.
...
[Node.JS](https://nodejs.org) must be installed on your computer. We suggest using an up-to-date LTS version of NodeJS (currently 16.17.0LTS).
...
Starting Windows 7 - all versions

**MacOS**

Starting macOS 10.11
...
Rainbow CLI benefits

**A. Own a company**

1\. Create a Rainbow user  
2\. Create your own company  
  
Your Rainbow account will obtain the `Company admin rights`

You can use the **company** commands to manage your users.

**B. Become developer**

1\. Sign-in to the [Rainbow for Developers](/) portal  
2\. Accept the terms and conditions  
  
Your Rainbow account will obtain the `Developer rights`

You can use the **developer** commands to create and manage your application.

**C. Manage several companies**

If you need more that one companies, please contact the [Rainbow support](mailto:support@openrainbow.com) team in order to obtain the **Organization rights**.

You can use the **organization** commands to create companies and manage users of these companies.
...
**A. Activate your Sandbox account**

1\. Log-in to the [Rainbow for Developers](/) portal  
2\. Create your Developer Sandbox account.

You can use the **company** and **developer** commands to manage users and applications

**B. Manage several companies**

Please contact the [Rainbow support](mailto:support@openrainbow.com) team in order to obtain the `Organization rights`
...
-   Connect to the [Rainbow for Developers](/) portal with your Rainbow developer account,
...
Working on Production platform

Working on Developers Sandbox platform

1\. Sign-in the [Rainbow for Developers](/) portal and accept the terms and conditions  
2\. Create an application.  
3\. Execute command `rbw configure` to select the production platform and enter the application ID and secret key.  
4\. Execute command `rbw login` to connect to Rainbow Production platform  
5\. Opt-in. Create your own company to manage your users.

1\. Log-in to the [Rainbow for Developers](/) portal  
2\. Create your Developers Sandbox account  
3\. Execute command `rbw configure` to select the developers sandbox platform platform  
4\. Execute command `rbw login` to connect to Rainbow Developers Sandbox Platform.
...
```bash
$ sudo npm install -g rainbow-cli
```

#### Windows

```bash
C:\> npm install -g rainbow-cli
```
...
Once the Rainbow CLI application is installed, you can launch commands using the following syntax (whatever operating system is used):
...
-   [Rainbow CLI: Getting Started](/docs/sdk/cli/tutorials/Getting_started#name-rainbow-cli:-getting-started-0)
-   [Preamble](/docs/sdk/cli/tutorials/Getting_started#name-preamble-10)
-   [Prerequisites](/docs/sdk/cli/tutorials/Getting_started#name-prerequisites-26)
-   [Node.JS Support](/docs/sdk/cli/tutorials/Getting_started#name-node.js-support-33)
-   [Operating systems support](/docs/sdk/cli/tutorials/Getting_started#name-operating-systems-support-43)
-   [Rainbow account](/docs/sdk/cli/tutorials/Getting_started#name-rainbow-account-88)
-   [Rainbow account on Production platform](/docs/sdk/cli/tutorials/Getting_started#name-rainbow-account-on-production-platform-115)
-   [Rainbow account on Sandbox platform for developers](/docs/sdk/cli/tutorials/Getting_started#name-rainbow-account-on-sandbox-platform-for-developers-169)
-   [Rainbow Application ID and Secret Key](/docs/sdk/cli/tutorials/Getting_started#name-rainbow-application-id-and-secret-key-212)
-   [Rainbow Pre-requisites summary](/docs/sdk/cli/tutorials/Getting_started#name-rainbow-pre-requisites-summary-247)
-   [Install](/docs/sdk/cli/tutorials/Getting_started#name-install-276)
-   [Linux](/docs/sdk/cli/tutorials/Getting_started#name-linux-283)
-   [Windows](/docs/sdk/cli/tutorials/Getting_started#name-windows-290)
-   [Usage](/docs/sdk/cli/tutorials/Getting_started#name-usage-297)
-   [Role and profile](/docs/sdk/cli/tutorials/Getting_started#name-role-and-profile-323)
-   [Commands](/docs/sdk/cli/tutorials/Getting_started#name-commands-330)
-   [Help on commands](/docs/sdk/cli/tutorials/Getting_started#name-help-on-commands-338)
-   [Configure the Rainbow CLI and connect to Rainbow](/docs/sdk/cli/tutorials/Getting_started#name-configure-the-rainbow-cli-and-connect-to-rainbow-346)
-   [Outputs and scripts](/docs/sdk/cli/tutorials/Getting_started#name-outputs-and-scripts-364)
-   [Piping output to a JSON processor](/docs/sdk/cli/tutorials/Getting_started#name-piping-output-to-a-json-processor-374)
-   [Piping output to a NodeJS application](/docs/sdk/cli/tutorials/Getting_started#name-piping-output-to-a-nodejs-application-382)
-   [Debugging](/docs/sdk/cli/tutorials/Getting_started#name-debugging-397)

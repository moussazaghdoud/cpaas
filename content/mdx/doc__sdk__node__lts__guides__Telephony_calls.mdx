...
description: ""
type: "sdk"
source: "https://developers.openrainbow.com/doc/sdk/node/lts/guides/Telephony_calls"
lastSynced: "2026-02-20T07:12:33.274Z"
---
# Documentation
...
Rainbow Telephony is heavily dependent on the events received by the connected users. There are two main types of 3PCC telephony events: those informing about the system changes (i.e. telephony started or nomadic state changed) and those being activated during a call. First category of events include:
...
### rainbow\_oncallupdated event sequence
...
The conferences are described in the following guide [Conferences](/docs/sdk/node) . The events call about conferences are :
...
### rainbow\_onbubbleconferencestartedreceived
...
### rainbow\_onbubbleconferenceupdated
...
### rainbow\_onbubbleconferencestoppedreceived
...
Rainbow Telephony is heavily dependent on the events received by the connected users. Events include:
...
The presence event give the SDK the information about the connected user. It provides the global rainbow "phone" presence, and also the presence for the resources of the connected user.
...
-   [Telephony calls](/docs/sdk/node#name-telephony-calls-0)
-   [3PCC Events calls](/docs/sdk/node#name-3pcc-events-calls-8)
-   [rainbow\_oncallupdated event sequence](/docs/sdk/node#name-rainbow_oncallupdated-event-sequence-52)
-   [Outgoing Telephony call event sequence](/docs/sdk/node#name-outgoing-telephony-call-event-sequence-59)
-   [Incoming Telephony call event sequence](/docs/sdk/node#name-incoming-telephony-call-event-sequence-203)
-   [Conference calls](/docs/sdk/node#name-conference-calls-303)
-   [rainbow\_onbubbleconferencestartedreceived](/docs/sdk/node#name-rainbow_onbubbleconferencestartedreceived-327)
-   [rainbow\_onbubbleconferenceupdated](/docs/sdk/node#name-rainbow_onbubbleconferenceupdated-334)
-   [rainbow\_onbubbleconferencestoppedreceived](/docs/sdk/node#name-rainbow_onbubbleconferencestoppedreceived-341)
-   [P2P WEBRTC Calls](/docs/sdk/node#name-p2p-webrtc-calls-348)
-   [Incomming calls Events](/docs/sdk/node#name-incomming-calls-events-355)
-   [rainbow\_onmediapropose](/docs/sdk/node#name-rainbow_onmediapropose-394)
-   [rainbow\_onmediaretract](/docs/sdk/node#name-rainbow_onmediaretract-402)
-   [rainbow\_onmediaaccept](/docs/sdk/node#name-rainbow_onmediaaccept-410)
-   [rainbow\_onpresencechanged](/docs/sdk/node#name-rainbow_onpresencechanged-418)
-   [Outgoing Telephony call event sequence](/docs/sdk/node#name-outgoing-telephony-call-event-sequence-426)

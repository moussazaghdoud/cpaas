...
type: "sdk"
source: "/docs/sdk/csharp/core/lts/guides/070_managing_presence"
lastSynced: "2026-02-20T07:47:22.075Z"
---
# Documentation
...
-   [Roster](/docs/sdk/csharp#name-roster-9)
-   [Get Contact Presence by devices](/docs/sdk/csharp#name-get-contact-presence-by-devices-26)
-   [Get Aggregated Presence](/docs/sdk/csharp#name-get-aggregated-presence-40)
-   [Manage events related to presence](/docs/sdk/csharp#name-manage-events-related-to-presence-51)
-   [Manage Presence of the current contact](/docs/sdk/csharp#name-manage-presence-of-the-current-contact-68)
-   [Set default presence once connected to the server](/docs/sdk/csharp#name-set-default-presence-once-connected-to-the-server-94)
-   [Examples](/docs/sdk/csharp#name-examples-105)

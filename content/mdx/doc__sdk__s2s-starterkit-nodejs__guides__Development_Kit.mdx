...
description: ""
type: "sdk"
source: "https://developers.openrainbow.com/doc/sdk/s2s-starterkit-nodejs/guides/Development_Kit"
lastSynced: "2026-02-20T07:12:33.827Z"
---
# Documentation
...
-   Rainbow-S2S-StarterKit-NodeJS package witch provides an S2S Starter kit engine core with Services bots can use to interact with rainbow platform. For the moment ImService and Pesence Service are availabe.
...
-   [S2S Starter Kit](/docs/sdk/s2s-starterkit-nodejs/guides/Development_Kit#name-s2s-starter-kit-0)
-   [Rainbow-S2S-StarterKit-NodeJS](/docs/sdk/s2s-starterkit-nodejs/guides/Development_Kit#name-rainbow-s2s-starterkit-nodejs-23)
-   [Appplications samples](/docs/sdk/s2s-starterkit-nodejs/guides/Development_Kit#name-appplications-samples-30)

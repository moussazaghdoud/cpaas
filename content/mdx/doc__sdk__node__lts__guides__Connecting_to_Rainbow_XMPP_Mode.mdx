...
description: ""
type: "sdk"
source: "https://developers.openrainbow.com/doc/sdk/node/lts/guides/Connecting_to_Rainbow_XMPP_Mode"
lastSynced: "2026-02-20T07:12:33.035Z"
---
# Documentation

Connecting to Rainbow in XMPP Mode (Default, full features)
...
**Full option's description** is available in [sdk constructor options](/docs/sdk/node#sdkconstructoroptions)
...
|  
v  
**rainbow\_onstopped** or **rainbow\_onfailed** or **rainbow\_onerror**  
EVENTs  
|  
v  
STATE  
`stopped` or `failed` or `error`  
...
-   [State stopped](/docs/sdk/node#name-state-stopped-159)
-   [State starting](/docs/sdk/node#name-state-starting-169)
-   [State started](/docs/sdk/node#name-state-started-179)
-   [State connected](/docs/sdk/node#name-state-connected-186)
-   [State ready](/docs/sdk/node#name-state-ready-196)
-   [State disconnected](/docs/sdk/node#name-state-disconnected-206)
-   [State reconnecting](/docs/sdk/node#name-state-reconnecting-216)
-   [State failed](/docs/sdk/node#name-state-failed-229)
-   [Events](/docs/sdk/node#name-events-248)
-   [Event rainbow\_onstarted](/docs/sdk/node#name-event-rainbow_onstarted-341)
-   [Event rainbow\_onstopped](/docs/sdk/node#name-event-rainbow_onstopped-351)
-   [Event rainbow\_onconnected](/docs/sdk/node#name-event-rainbow_onconnected-361)
-   [Event rainbow\_onready](/docs/sdk/node#name-event-rainbow_onready-371)
-   [Event rainbow\_onconnectionerror](/docs/sdk/node#name-event-rainbow_onconnectionerror-384)
-   [Event rainbow\_ondisconnected](/docs/sdk/node#name-event-rainbow_ondisconnected-391)
-   [Event rainbow\_onreconnecting](/docs/sdk/node#name-event-rainbow_onreconnecting-398)
-   [Event rainbow\_onfailed](/docs/sdk/node#name-event-rainbow_onfailed-405)
-   [Event rainbow\_onerror](/docs/sdk/node#name-event-rainbow_onerror-412)

...
description: ""
type: "sdk"
source: "https://developers.openrainbow.com/doc/sdk/node/lts/guides/CHANGELOG"
lastSynced: "2026-02-20T07:12:32.997Z"
---
# Documentation

ChangeLog

LTS release 2.XPublished on 2025-01-01Compare

## CHANGELOG SDK for Node.JS

---

Here is the list of the changes and features provided by the **Rainbow-Node-SDK** Warning: Before deploying in production a bot that can generate heavy traffic, please contact ALE. All notable changes to Rainbow-Node-SDK will be documented in this file.
...
-   Fix Agent for proxy in requests in `HttpService`.
...
-   Fix JSdoc about parameter p\_messagesDataStore in APIs.
...
-   Add p\_messagesDataStore: DataStoreType = undefined parameter to several method to send messages. It is used to override the general of SDK's parameter "messagesDataStore".
...
-   Update `retrieveLdapConnectorConfig` (API GET /api/rainbow/admin/v1.0/connectors/ldaps/config) add the parameter "p\_type". returns oldest config (for retro-compatibility, field `ldapConfigId` is used to compute numbers). should no longer be used by ldap\_connector.
...
-   Update event "rainbow\_onconnectorcommand" with `ldapConfigId` property in the data object.
...
-   Fix `S2SServiceEventHandler::ParseRoomStateCallback` to emit "evt\_internal\_onbubblepresencechanged" to treat the promise of the sent initial bubble presence request.
...
-   Add `ImsService::updatePinWithPeerId` This API can be used to add a pin in user's Pins list with peerId.
...
-   Remove child event in XMPPService in fn\_STANZA\_EVENT callback. To increase speed of treatment.
...
-   Add event "rainbow\_on429BackoffError" Fired when a request initially failed and is trying to be retreated by backoff process.
...
-   Fix S2S presence in bubble event evt\_internal\_ownaffiliationchanged event.
-   Fix typo "LOCK\_TIMEOUT\_QUEUE"
...
-   Add "rainbow\_ontaskcreated", "rainbow\_ontaskupdated", "rainbow\_ontaskdeleted" events about tasks.
...
-   Update logs API\_ID in `AdminService`.
-   Update logs API\_ID in `AlertsService`.
-   Update logs API\_ID in `FileStorageService`.
...
-   Rollback the modifications done to increase the startup because the init of the services was not correct when the SDK sent the rainbow\_onready event.
...
-   Update callback event on "evt\_internal\_signinrequired" event to reconnect with the previously used singin method (signin or signinWSOnly).
...
-   Fix attention when user's jid\_im is in mention array of an history message.
...
-   Add the ability to choose a customized specific xmpp resource name with an init option `xmppRessourceName`. The resource will be "node\_+`xmppRessourceName`".
...
-   Updated the documentation of `AdminService::sendCommandToLdapConnectorUser` API of `command` parameter possible values : "manual\_synchro\_directories", "manual\_dry\_run\_directories".
...
-   Add fileId when a file is attached in 'oob' property of data of a "rainbow\_onmessagereceived".
...
-   Add event `rainbow_onconnectorconfig` fired when a config is sent to connector's jid\_im.
-   Add Bubble property in data of the 'rainbow\_onbubbleconferenceupdated' event.
-   Fix lts\_version.json file used to generate the image tab with the support's dates.
...
-   Fix the XMPPService (handleXMPPConnection) when ERROR\_EVENT happenned to stop the ping timer only when the error is a fatal one.
...
-   Change the max value of nbHttpAdded to Number.MAX\_SAFE\_INTEGER
...
-   Fix XMPP resource name to have the string "node\_" at the beginning of it.
...
-   Add the events rainbow\_onbubbleconferencestartedreceived rainbow\_onbubbleconferencestoppedreceived when a webrtc conference start/stop.
...
-   Update libs to lastest version : `ncu -u` , so update sitemap library => fix sitemap\_generation
...
-   Rename document Connecting\_to\_Rainbow to Connecting\_to\_Rainbow\_XMPP\_Mode.
-   Add document Connecting\_to\_Rainbow\_S2S\_Mode to describe the connection to Rainbow with a S2S event pipe.
...
-   Add events treatment S2SServiceEventHandler :: ParseChatStateCallback, ParseReceitpCallback, ParseAllReceitpCallback, ParseConversationCallback, ParseMessageCallback, ParseRoomInviteCallback, ParseRoomMemberCallback, ParseRoomStateCallback, ParseAlldeletedCallback, ParseErrorCallback.
...
-   Fix : event presence rainbow\_oncontactpresencechanged when a contact in the roster is on phone.
-   Fix : put the SDK to STOPPED state if "rainbow\_xmppdisconnect" arrive and the reconnection is disabled.
-   CRRAINB-6601 : Fix : Allows to make a second 3PCC RCC if the second call is allowed in profile.
-   Add internals telephony events raised outside the SDK to allow Afterbuild receveid multiple events : "evt\_internal\_callupdated\_\*\*\*". Must not be used outside Afterbuild context. Note it is available only when internal traces are enabled.
...
-   Add Favorites events (rainbow\_onfavoritecreated, rainbow\_onfavoritedeleted)
-   Add Favorites doc
...
Update comments limitations => limits Update ImsService::sendMessageToJidAnswer and XMPPService::sendChatMessage with a new parameter answeredMsg to allow to send a reply to a message Update ImsService::sendMessageToBubbleJidAnswer and XMPPService::sendChatMessageToBubble with a new parameter answeredMsg to allow to send a reply to a message Update conversationEventHandler to handle the conversation Events from server (create/update) fix ContactsService::getRosters to return the list of contacts Add ConversationsService::getConversationByDbId method to retrieve a conversation from the dbid identifier. Explain isTyping in the "Chatting with Rainbow users" guide Rename the method `ChannelsService::createPrivateChannel()` to `ChannelsService::CreateClosedChannel` Rename the method `ChannelsService::deleteMessageFromChannel()` to `ChannelsService::deleteItemFromChannel` Rename the method `ChannelsService::getMessagesFromChannel()` to `ChannelsService::fetchChannelItems` Rename the method `ChannelsService::removeUsersFromChannel1()` to `ChannelsService::deleteUsersFromChannel` Rename the method `ChannelsService::removeAllUsersFromChannel()` to `ChannelsService::deleteAllUsersFromChannel` Rename the method `ChannelsService::getUsersFromChannel()` to `ChannelsService::fetchChannelUsers` Rename the method `ChannelsService::getChannelById()` to `ChannelsService::fetchChannel` Rename the method `ChannelsService::publishMessageToChannel()` to `ChannelsService::createItem` Add `ChannelsService::fetchChannelsByFilter` method retrieve a channel by filter Fix wrong `INCOMMING` spelling to `INCOMING`, `incomming` to `incoming`, `Incomming` to `Incoming` Rename the method `ChannelsService::getAllOwnedChannel()` to `ChannelsService::getAllOwnedChannels` Rename the method `ChannelsService::getAllSubscribedChannel()` to `ChannelsService::getAllSubscribedChannels` Refactor ChannelsService to return the real Channel type in API/Events Refactor ChannelsService to use the return types Add ContactsService::getConnectedUser method to get the connected user information Add ChannelsService::updateChannelVisibility method to update a channel visibility (closed or company) Add ChannelsService::updateChannelVisibilityToPublic method to update a channel visibility to company (visible for users in that company) Add ChannelsService::updateChannelVisibilityToClosed method to update a channel visibility to closed (not visible by users) Add ChannelsService::updateChannelTopic method to update the description of the channel to update (max-length=255) Add ChannelsService::updateChannelName method to update a channel name Update AdminService::createUserInCompany to add the roles parameter when creating a user. Reduce log for the XMPP ping.

### \[1.54.6\] - 2019-04-09

Update doc Fix of FileStorageService::retrieveAndStoreOneFileDescriptor Add method ContactService::acceptInvitation Accept a an invitation from an other Rainbow user to mutually join the network Add method ContactService::declineInvitation Decline an invitation from an other Rainbow user to mutually join the network Update onFileManagementMessageReceived event with the file descriptor data Fix some type issue find by typescript
...
-   Add event rainbow\_onpresencechanged fired when the presence of the connected user changes.
...
-   Add images property in message retrieved from channels with method channels::getMessagesFromChannel and also when event "rainbow\_onchannelmessagereceived" is fired
...
-   Add event fired when a message is delete in a channel : rainbow\_onchannelmessagedeletedreceived
-   Add event fired when a channel is created : rainbow\_onchannelcreated
-   Add event fired when a channel is deleted : rainbow\_channeldeleted
...
-   Add "system-dev" section in logs for DEVELOPPEMENT ONLY, no production system should use it : "internals" for logs level of debug + unsensored data. Warning password and so on can be logs, it should only be used in dev environement ! "http" moved from logs sections, kept the same behaviour
...
-   Add the method `conversations::sendCorrectedChatMessage` to send a corrected message to a conversation. This method works for sending messages to a one-to-one conversation or to a bubble conversation. ! Note ! : only the last sent message on the conversation can be changed. The connected user must be the sender of the original message.\`
...
-   Add event fired when a channel is updated : rainbow\_channelupdated
...
-   Add file management event handler for Xmpp : rainbow\_filecreated rainbow\_fileupdated rainbow\_filedeleted rainbow\_thumbnailcreated
-   Refactor contacts to return the correct type "Contact" of data on few use cases in severals methods
-   Add methods in FileStorage : removeFile(); getFileDescriptorFromId(); getFilesReceivedInConversation(); getFilesReceivedInBubble(); getFilesSentInConversation(); getFilesSentInBubble(); getUserQuotaConsumption(); getAllFilesSent(); getAllFilesReceived()
...
-   #CRRAINB-2838 - Event rainbow\_onbubbleaffiliationchanged cand be fired
...
-   #CRRAINB-1637: Increase attempt and MAX\_DELAY when trying to reconnect the REST part
...
-   #28868: Fix documentation around event rainbow\_onmessagereceived
...
-   \[Bubble\] New event **rainbow\_onbubbleinvitationreceived** added for handling invitation to join a bubble
-   \[Bubble\] New event **rainbow\_onbubbleownaffiliationchanged** added for handling user connected affiliation changes in a bubble
...
-   [CHANGELOG SDK for Node.JS](/docs/sdk/node#name-changelog-sdk-for-node.js-0)
-   [\[2.42.0-lts.0\] - 2025-10-17](/doc/sdk/node/lts/guides/CHANGELOG#name-2.42.0-lts.0---2025-10-17-7)
-   [\[2.41.4\] - 2025-10-17](/doc/sdk/node/lts/guides/CHANGELOG#name-2.41.4---2025-10-17-50)
-   [\[2.41.3\] - 2025-10-10](/doc/sdk/node/lts/guides/CHANGELOG#name-2.41.3---2025-10-10-118)
-   [\[2.41.2\] - 2025-10-08](/doc/sdk/node/lts/guides/CHANGELOG#name-2.41.2---2025-10-08-161)
-   [\[2.41.1\] - 2025-09-25](/doc/sdk/node/lts/guides/CHANGELOG#name-2.41.1---2025-09-25-219)
-   [\[2.41.0\] - 2025-09-24](/doc/sdk/node/lts/guides/CHANGELOG#name-2.41.0---2025-09-24-262)
-   [\[2.40.0-lts.0\] - 2025-09-01](/doc/sdk/node/lts/guides/CHANGELOG#name-2.40.0-lts.0---2025-09-01-320)
-   [\[2.39.1\] - 2025-08-27](/doc/sdk/node/lts/guides/CHANGELOG#name-2.39.1---2025-08-27-363)
-   [\[2.39.0\] - 2025-08-20](/doc/sdk/node/lts/guides/CHANGELOG#name-2.39.0---2025-08-20-406)
-   [\[2.38.0\] - 2025-08-08](/doc/sdk/node/lts/guides/CHANGELOG#name-2.38.0---2025-08-08-474)
-   [\[2.37.0-lts.0\] - 2025-03-13](/doc/sdk/node/lts/guides/CHANGELOG#name-2.37.0-lts.0---2025-03-13-597)
-   [\[2.36.1\] - 2025-05-13](/doc/sdk/node/lts/guides/CHANGELOG#name-2.36.1---2025-05-13-640)
-   [\[2.36.0\] - 2025-05-12](/doc/sdk/node/lts/guides/CHANGELOG#name-2.36.0---2025-05-12-683)
-   [\[2.35.0-lts.0\] - 2025-03-13](/doc/sdk/node/lts/guides/CHANGELOG#name-2.35.0-lts.0---2025-03-13-801)
-   [\[2.34.2\] - 2025-03-13](/doc/sdk/node/lts/guides/CHANGELOG#name-2.34.2---2025-03-13-844)
-   [\[2.34.1\] - 2025-03-04](/doc/sdk/node/lts/guides/CHANGELOG#name-2.34.1---2025-03-04-887)
-   [\[2.34.0\] - 2025-03-04](/doc/sdk/node/lts/guides/CHANGELOG#name-2.34.0---2025-03-04-930)
-   [\[2.33.1\] - 2025-02-14](/doc/sdk/node/lts/guides/CHANGELOG#name-2.33.1---2025-02-14-1028)
-   [\[2.33.0\] - 2025-02-13](/doc/sdk/node/lts/guides/CHANGELOG#name-2.33.0---2025-02-13-1071)
-   [\[2.32.0-lts.2\] - 2024-11-26](/doc/sdk/node/lts/guides/CHANGELOG#name-2.32.0-lts.2---2024-11-26-1254)
-   [\[2.32.0-lts.0\] - 2024-11-22](/doc/sdk/node/lts/guides/CHANGELOG#name-2.32.0-lts.0---2024-11-22-1302)
-   [\[2.31.0\] - 2024-11-22](/doc/sdk/node/lts/guides/CHANGELOG#name-2.31.0---2024-11-22-1345)
-   [\[2.30.0\] - 2024-07-03](/doc/sdk/node/lts/guides/CHANGELOG#name-2.30.0---2024-07-03-1508)
-   [\[2.29.0\] - 2024-05-24](/doc/sdk/node/lts/guides/CHANGELOG#name-2.29.0---2024-05-24-1581)
-   [\[2.28.3\] - 2024-04-04](/doc/sdk/node/lts/guides/CHANGELOG#name-2.28.3---2024-04-04-1634)
-   [\[2.28.2\] - 2024-03-29](/doc/sdk/node/lts/guides/CHANGELOG#name-2.28.2---2024-03-29-1677)
-   [\[2.28.1\] - 2024-03-29](/doc/sdk/node/lts/guides/CHANGELOG#name-2.28.1---2024-03-29-1720)
-   [\[2.28.0\] - 2024-03-20](/doc/sdk/node/lts/guides/CHANGELOG#name-2.28.0---2024-03-20-1773)
-   [\[2.27.1\] - 2024-01-22](/doc/sdk/node/lts/guides/CHANGELOG#name-2.27.1---2024-01-22-1896)
-   [\[2.27.0\] - 2024-01-12](/doc/sdk/node/lts/guides/CHANGELOG#name-2.27.0---2024-01-12-1969)
-   [\[2.26.0\] - 2023-12-12](/doc/sdk/node/lts/guides/CHANGELOG#name-2.26.0---2023-12-12-2062)
-   [\[2.25.2-lts.5\] - 2024-01-11](/doc/sdk/node/lts/guides/CHANGELOG#name-2.25.2-lts.5---2024-01-11-2110)
-   [\[2.25.2-lts.4\] - 2023-10-20](/doc/sdk/node/lts/guides/CHANGELOG#name-2.25.2-lts.4---2023-10-20-2183)
-   [\[2.25.2-lts.3\] - 2023-10-20](/doc/sdk/node/lts/guides/CHANGELOG#name-2.25.2-lts.3---2023-10-20-2226)
-   [\[2.25.2-lts.2\] - 2023-10-17](/doc/sdk/node/lts/guides/CHANGELOG#name-2.25.2-lts.2---2023-10-17-2279)
-   [\[2.25.2-lts.1\] - 2023-10-03](/doc/sdk/node/lts/guides/CHANGELOG#name-2.25.2-lts.1---2023-10-03-2337)
-   [\[2.25.1\] - 2023-09-13](/doc/sdk/node/lts/guides/CHANGELOG#name-2.25.1---2023-09-13-2385)
-   [\[2.25.0\] - 2023-09-11](/doc/sdk/node/lts/guides/CHANGELOG#name-2.25.0---2023-09-11-2428)
-   [\[2.24.3\] - 2023-08-21](/doc/sdk/node/lts/guides/CHANGELOG#name-2.24.3---2023-08-21-2481)
-   [\[2.24.2\] - 2023-08-21](/doc/sdk/node/lts/guides/CHANGELOG#name-2.24.2---2023-08-21-2524)
-   [\[2.24.1\] - 2023-08-18](/doc/sdk/node/lts/guides/CHANGELOG#name-2.24.1---2023-08-18-2567)
-   [\[2.24.0\] - 2023-08-10](/doc/sdk/node/lts/guides/CHANGELOG#name-2.24.0---2023-08-10-2610)
-   [\[2.23.1\] - 2023-07-07](/doc/sdk/node/lts/guides/CHANGELOG#name-2.23.1---2023-07-07-2840)
-   [\[2.23.0\] - 2023-07-04](/doc/sdk/node/lts/guides/CHANGELOG#name-2.23.0---2023-07-04-2850)
-   [\[2.22.4\] - 2023-05-26](/doc/sdk/node/lts/guides/CHANGELOG#name-2.22.4---2023-05-26-2925)
-   [\[2.22.3\] - 2023-05-24](/doc/sdk/node/lts/guides/CHANGELOG#name-2.22.3---2023-05-24-2940)
-   [\[2.22.2\] - 2023-05-23](/doc/sdk/node/lts/guides/CHANGELOG#name-2.22.2---2023-05-23-2950)
-   [\[2.22.1\] - 2023-05-11](/doc/sdk/node/lts/guides/CHANGELOG#name-2.22.1---2023-05-11-2970)
-   [\[2.22.0\] - 2023-05-10](/doc/sdk/node/lts/guides/CHANGELOG#name-2.22.0---2023-05-10-2980)
-   [\[2.21.0\] - 2023-04-14](/doc/sdk/node/lts/guides/CHANGELOG#name-2.21.0---2023-04-14-3000)
-   [\[2.20.0\] - 2023-02-24](/doc/sdk/node/lts/guides/CHANGELOG#name-2.20.0---2023-02-24-3300)
-   [\[2.19.0\] - 2023-01-09](/doc/sdk/node/lts/guides/CHANGELOG#name-2.19.0---2023-01-09-3415)
-   [\[2.18.0\] - 2022-12-09](/doc/sdk/node/lts/guides/CHANGELOG#name-2.18.0---2022-12-09-3480)
-   [\[2.17.0\] - 2022-10-28](/doc/sdk/node/lts/guides/CHANGELOG#name-2.17.0---2022-10-28-3535)
-   [\[2.16.1-lts.3\] - 2022-12-09](/doc/sdk/node/lts/guides/CHANGELOG#name-2.16.1-lts.3---2022-12-09-3545)
-   [\[2.16.1-lts.2\] - 2022-11-18](/doc/sdk/node/lts/guides/CHANGELOG#name-2.16.1-lts.2---2022-11-18-3555)
-   [\[2.16.1-lts.1\] - 2022-11-07](/doc/sdk/node/lts/guides/CHANGELOG#name-2.16.1-lts.1---2022-11-07-3570)
-   [\[2.16.1-lts.0\] - 2022-10-28](/doc/sdk/node/lts/guides/CHANGELOG#name-2.16.1-lts.0---2022-10-28-3590)
-   [\[2.16.0-lts.0\] - 2022-10-07](/doc/sdk/node/lts/guides/CHANGELOG#name-2.16.0-lts.0---2022-10-07-3620)
-   [\[2.15.3\] - 2022-10-07](/doc/sdk/node/lts/guides/CHANGELOG#name-2.15.3---2022-10-07-3630)
-   [\[2.15.2\] - 2022-09-13](/doc/sdk/node/lts/guides/CHANGELOG#name-2.15.2---2022-09-13-3680)
-   [\[2.15.1\] - 2022-09-02](/doc/sdk/node/lts/guides/CHANGELOG#name-2.15.1---2022-09-02-3720)
-   [\[2.15.0\] - 2022-08-25](/doc/sdk/node/lts/guides/CHANGELOG#name-2.15.0---2022-08-25-3765)
-   [\[2.14.1\] - 2022-07-07](/doc/sdk/node/lts/guides/CHANGELOG#name-2.14.1---2022-07-07-3885)
-   [\[2.14.0\] - 2022-07-07](/doc/sdk/node/lts/guides/CHANGELOG#name-2.14.0---2022-07-07-3900)
-   [\[2.13.0\] - 2022-06-16](/doc/sdk/node/lts/guides/CHANGELOG#name-2.13.0---2022-06-16-3960)
-   [\[2.12.0\] - 2022-06-03](/doc/sdk/node/lts/guides/CHANGELOG#name-2.12.0---2022-06-03-4030)
-   [\[2.10.0-lts.10\] - 2022-06-03](/doc/sdk/node/lts/guides/CHANGELOG#name-2.10.0-lts.10---2022-06-03-4040)
-   [\[2.10.0-lts.9\] - 2022-05-25](/doc/sdk/node/lts/guides/CHANGELOG#name-2.10.0-lts.9---2022-05-25-4055)
-   [\[2.10.0-lts.8\] - 2022-05-13](/doc/sdk/node/lts/guides/CHANGELOG#name-2.10.0-lts.8---2022-05-13-4075)
-   [\[2.11.2\] - 2022-05-11](/doc/sdk/node/lts/guides/CHANGELOG#name-2.11.2---2022-05-11-4090)
-   [\[2.11.1\] - 2022-05-09](/doc/sdk/node/lts/guides/CHANGELOG#name-2.11.1---2022-05-09-4105)
-   [\[2.11.0\] - 2022-04-05](/doc/sdk/node/lts/guides/CHANGELOG#name-2.11.0---2022-04-05-4120)
-   [\[2.10.0-lts.7\] - 2022-05-10](/doc/sdk/node/lts/guides/CHANGELOG#name-2.10.0-lts.7---2022-05-10-4165)
-   [\[2.10.0-lts.6\] - 2022-05-03](/doc/sdk/node/lts/guides/CHANGELOG#name-2.10.0-lts.6---2022-05-03-4175)
-   [\[2.10.0-lts.5\] - 2022-04-08](/doc/sdk/node/lts/guides/CHANGELOG#name-2.10.0-lts.5---2022-04-08-4195)
-   [\[2.10.0-lts.4\] - 2022-04-08](/doc/sdk/node/lts/guides/CHANGELOG#name-2.10.0-lts.4---2022-04-08-4205)
-   [\[2.10.0-lts.3\] - 2022-04-07](/doc/sdk/node/lts/guides/CHANGELOG#name-2.10.0-lts.3---2022-04-07-4215)
-   [\[2.10.0-lts.2\] - 2022-04-07](/doc/sdk/node/lts/guides/CHANGELOG#name-2.10.0-lts.2---2022-04-07-4225)
-   [\[2.10.0-lts.1\] - 2022-04-07](/doc/sdk/node/lts/guides/CHANGELOG#name-2.10.0-lts.1---2022-04-07-4235)
-   [\[2.10.0-lts.0\] - 2022-04-07](/doc/sdk/node/lts/guides/CHANGELOG#name-2.10.0-lts.0---2022-04-07-4245)
-   [\[2.9.1\] - 2022-03-23](/doc/sdk/node/lts/guides/CHANGELOG#name-2.9.1---2022-03-23-4360)
-   [\[2.9.0\] - 2022-03-18](/doc/sdk/node/lts/guides/CHANGELOG#name-2.9.0---2022-03-18-4370)
-   [\[2.8.2\] - 2022-02-18](/doc/sdk/node/lts/guides/CHANGELOG#name-2.8.2---2022-02-18-4475)
-   [\[2.8.1\] - 2022-02-07](/doc/sdk/node/lts/guides/CHANGELOG#name-2.8.1---2022-02-07-4782)
-   [\[2.8.0\] - 2022-01-28](/doc/sdk/node/lts/guides/CHANGELOG#name-2.8.0---2022-01-28-4827)
-   [\[2.7.0\] - 2021-12-0](/doc/sdk/node/lts/guides/CHANGELOG#name-2.7.0---2021-12-0-4882)
-   [\[2.6.2\] - 2021-12-02](/doc/sdk/node/lts/guides/CHANGELOG#name-2.6.2---2021-12-02-4907)
-   [\[2.6.1\] - 2021-11-19](/doc/sdk/node/lts/guides/CHANGELOG#name-2.6.1---2021-11-19-4947)
-   [\[2.6.0\] - 2021-11-18](/doc/sdk/node/lts/guides/CHANGELOG#name-2.6.0---2021-11-18-4957)
-   [\[2.1.0-lts.0\] - 2021-10-10](/doc/sdk/node/lts/guides/CHANGELOG#name-2.1.0-lts.0---2021-10-10-5022)
-   [\[2.5.1\] - 2021-10-06](/doc/sdk/node/lts/guides/CHANGELOG#name-2.5.1---2021-10-06-5042)
-   [\[2.5.0\] - 2021-09-13](/doc/sdk/node/lts/guides/CHANGELOG#name-2.5.0---2021-09-13-5067)
-   [\[2.4.0\] - 2021-09-13](/doc/sdk/node/lts/guides/CHANGELOG#name-2.4.0---2021-09-13-5117)
-   [\[2.3.0\] - 2021-08-13](/doc/sdk/node/lts/guides/CHANGELOG#name-2.3.0---2021-08-13-5227)
-   [\[2.2.0\] - 2021-06-28](/doc/sdk/node/lts/guides/CHANGELOG#name-2.2.0---2021-06-28-5242)
-   [\[2.1.1\] - 2021-06-10](/doc/sdk/node/lts/guides/CHANGELOG#name-2.1.1---2021-06-10-5447)
-   [\[2.1.0\] - 2021-06-09](/doc/sdk/node/lts/guides/CHANGELOG#name-2.1.0---2021-06-09-5482)
-   [\[2.0.1-lts.2\] - 2021-07-01](/doc/sdk/node/lts/guides/CHANGELOG#name-2.0.1-lts.2---2021-07-01-5732)
-   [\[2.0.1-lts.1\] - 2021-05-20](/doc/sdk/node/lts/guides/CHANGELOG#name-2.0.1-lts.1---2021-05-20-5742)
-   [\[2.0.0-lts.1\] - 2021-05-20](/doc/sdk/node/lts/guides/CHANGELOG#name-2.0.0-lts.1---2021-05-20-5752)
-   [\[2.0.0\] - 2021-04-20](/doc/sdk/node/lts/guides/CHANGELOG#name-2.0.0---2021-04-20-5777)
-   [\[1.87.0-test.16\] - 2021-04-20](/doc/sdk/node/lts/guides/CHANGELOG#name-1.87.0-test.16---2021-04-20-5802)
-   [\[1.87.0-test.0\] - 2021-04-16](/doc/sdk/node/lts/guides/CHANGELOG#name-1.87.0-test.0---2021-04-16-5812)
-   [\[1.86.0-dotnet.1\] - 2021-04-01](/doc/sdk/node/lts/guides/CHANGELOG#name-1.86.0-dotnet.1---2021-04-01-5822)
-   [\[1.86.0-dotnet.0\] - 2021-04-01](/doc/sdk/node/lts/guides/CHANGELOG#name-1.86.0-dotnet.0---2021-04-01-5832)
-   [\[1.85.1\] - 2021-03-18](/doc/sdk/node/lts/guides/CHANGELOG#name-1.85.1---2021-03-18-5922)
-   [\[1.85.0\] - 2021-03-18](/doc/sdk/node/lts/guides/CHANGELOG#name-1.85.0---2021-03-18-5932)
-   [\[1.85.0-dotnet.1\] - 2021-03-17](/doc/sdk/node/lts/guides/CHANGELOG#name-1.85.0-dotnet.1---2021-03-17-5942)
-   [\[1.85.0-dotnet.0\] - 2021-03-09](/doc/sdk/node/lts/guides/CHANGELOG#name-1.85.0-dotnet.0---2021-03-09-5972)
-   [\[1.84.0\] - 2021-02-22](/doc/sdk/node/lts/guides/CHANGELOG#name-1.84.0---2021-02-22-6037)
-   [\[1.84.0-dotnet.1\] - 2021-02-18](/doc/sdk/node/lts/guides/CHANGELOG#name-1.84.0-dotnet.1---2021-02-18-6047)
-   [\[1.84.0-dotnet.0\] - 2021-02-17](/doc/sdk/node/lts/guides/CHANGELOG#name-1.84.0-dotnet.0---2021-02-17-6067)
-   [\[1.83.0\] - 2021-02-03](/doc/sdk/node/lts/guides/CHANGELOG#name-1.83.0---2021-02-03-6107)
-   [\[1.83.0-dotnet.2\] - 2021-02-01](/doc/sdk/node/lts/guides/CHANGELOG#name-1.83.0-dotnet.2---2021-02-01-6137)
-   [\[1.83.0-dotnet.1\] - 2021-01-29](/doc/sdk/node/lts/guides/CHANGELOG#name-1.83.0-dotnet.1---2021-01-29-6157)
-   [\[1.83.0-dotnet.0\] - 2021-01-29](/doc/sdk/node/lts/guides/CHANGELOG#name-1.83.0-dotnet.0---2021-01-29-6160)
-   [\[1.82.0\] - 2021-01-22](/doc/sdk/node/lts/guides/CHANGELOG#name-1.82.0---2021-01-22-6185)
-   [\[1.82.0-dotnet.3\] - 2021-01-19](/doc/sdk/node/lts/guides/CHANGELOG#name-1.82.0-dotnet.3---2021-01-19-6220)
-   [\[1.82.0-debug.0\] - 2021-01-15](/doc/sdk/node/lts/guides/CHANGELOG#name-1.82.0-debug.0---2021-01-15-6235)
-   [\[1.82.0-dotnet.2\] - 2021-01-14](/doc/sdk/node/lts/guides/CHANGELOG#name-1.82.0-dotnet.2---2021-01-14-6250)
-   [\[1.82.0-dotnet.1\] - 2021-01-14](/doc/sdk/node/lts/guides/CHANGELOG#name-1.82.0-dotnet.1---2021-01-14-6260)
-   [\[1.82.0-dotnet.0\] - 2021-01-14](/doc/sdk/node/lts/guides/CHANGELOG#name-1.82.0-dotnet.0---2021-01-14-6270)
-   [\[1.81.1\] - 2021-01-06](/doc/sdk/node/lts/guides/CHANGELOG#name-1.81.1---2021-01-06-6280)
-   [\[1.81.0\] - 2021-01-06](/doc/sdk/node/lts/guides/CHANGELOG#name-1.81.0---2021-01-06-6290)
-   [\[1.81.0-dotnet.0\] - 2020-12-17](/doc/sdk/node/lts/guides/CHANGELOG#name-1.81.0-dotnet.0---2020-12-17-6320)
-   [\[1.80.0\] - 2020-12-02](/doc/sdk/node/lts/guides/CHANGELOG#name-1.80.0---2020-12-02-6355)
-   [\[1.80.0-dotnet.3\] - 2020-11-27](/doc/sdk/node/lts/guides/CHANGELOG#name-1.80.0-dotnet.3---2020-11-27-6365)
-   [\[1.80.0-dotnet.2\] - 2020-11-26](/doc/sdk/node/lts/guides/CHANGELOG#name-1.80.0-dotnet.2---2020-11-26-6375)
-   [\[1.80.0-dotnet.1\] - 2020-11-26](/doc/sdk/node/lts/guides/CHANGELOG#name-1.80.0-dotnet.1---2020-11-26-6410)
-   [\[1.79.2\] - 2020-11-18](/doc/sdk/node/lts/guides/CHANGELOG#name-1.79.2---2020-11-18-6445)
-   [\[1.80.0-dotnet.0\] - 2020-11-19](/doc/sdk/node/lts/guides/CHANGELOG#name-1.80.0-dotnet.0---2020-11-19-6455)
-   [\[1.79.1\] - 2020-11-18](/doc/sdk/node/lts/guides/CHANGELOG#name-1.79.1---2020-11-18-6470)
-   [\[1.79.0\] - 2020-11-13](/doc/sdk/node/lts/guides/CHANGELOG#name-1.79.0---2020-11-13-6480)
-   [\[1.79.0-dotnet.0\] - 2020-11-04](/doc/sdk/node/lts/guides/CHANGELOG#name-1.79.0-dotnet.0---2020-11-04-6515)
-   [\[1.78.1\] - 2020-11-04](/doc/sdk/node/lts/guides/CHANGELOG#name-1.78.1---2020-11-04-6525)
-   [\[1.78.0\] - 2020-10-15](/doc/sdk/node/lts/guides/CHANGELOG#name-1.78.0---2020-10-15-6555)
-   [\[1.78.0-dotnet.1\] - 2020-10-15](/doc/sdk/node/lts/guides/CHANGELOG#name-1.78.0-dotnet.1---2020-10-15-6565)
-   [\[1.78.0-dotnet.0\] - 2020-10-07](/doc/sdk/node/lts/guides/CHANGELOG#name-1.78.0-dotnet.0---2020-10-07-6585)
-   [\[1.77.0\] - 2020-09-30](/doc/sdk/node/lts/guides/CHANGELOG#name-1.77.0---2020-09-30-6605)
-   [\[1.77.0-dotnet.0\] - 2020-09-23](/doc/sdk/node/lts/guides/CHANGELOG#name-1.77.0-dotnet.0---2020-09-23-6635)
-   [\[1.76.0\] - 2020-09-09](/doc/sdk/node/lts/guides/CHANGELOG#name-1.76.0---2020-09-09-6695)
-   [\[1.76.0-dotnet.0\] - 2020-09-02](/doc/sdk/node/lts/guides/CHANGELOG#name-1.76.0-dotnet.0---2020-09-02-6725)
-   [\[1.75.0\] - 2020-08-19](/doc/sdk/node/lts/guides/CHANGELOG#name-1.75.0---2020-08-19-6735)
-   [\[1.75.0-dotnet.1\] - 2020-08-13](/doc/sdk/node/lts/guides/CHANGELOG#name-1.75.0-dotnet.1---2020-08-13-6750)
-   [\[1.75.0-dotnet.0\] - 2020-08-13](/doc/sdk/node/lts/guides/CHANGELOG#name-1.75.0-dotnet.0---2020-08-13-6760)
-   [\[1.73.0\] - 2020-07-08](/doc/sdk/node/lts/guides/CHANGELOG#name-1.73.0---2020-07-08-6770)
-   [\[1.73.0-dotnet.0\] - 2020-06-26](/doc/sdk/node/lts/guides/CHANGELOG#name-1.73.0-dotnet.0---2020-06-26-6785)
-   [\[1.72.0\] - 2020-17-06](/doc/sdk/node/lts/guides/CHANGELOG#name-1.72.0---2020-17-06-6805)
-   [\[1.72.0-dotnet.1\] - 2020-12-06](/doc/sdk/node/lts/guides/CHANGELOG#name-1.72.0-dotnet.1---2020-12-06-6815)
-   [\[1.72.0-dotnet.0\] - 2020-05-26](/doc/sdk/node/lts/guides/CHANGELOG#name-1.72.0-dotnet.0---2020-05-26-6830)
-   [\[1.71.0\] - 2020-05-07](/doc/sdk/node/lts/guides/CHANGELOG#name-1.71.0---2020-05-07-6840)
-   [\[1.71.0-dotnet.0\] - 2020-04-26](/doc/sdk/node/lts/guides/CHANGELOG#name-1.71.0-dotnet.0---2020-04-26-6850)
-   [\[1.70.0\] - 2020-04-16](/doc/sdk/node/lts/guides/CHANGELOG#name-1.70.0---2020-04-16-6885)
-   [\[1.70.0-dotnet.0\] - 2020-04-16](/doc/sdk/node/lts/guides/CHANGELOG#name-1.70.0-dotnet.0---2020-04-16-6900)
-   [\[1.69.0\] - 2020-03-30](/doc/sdk/node/lts/guides/CHANGELOG#name-1.69.0---2020-03-30-6985)
-   [\[1.69.0-dotnet.2\] - 2020-03-23](/doc/sdk/node/lts/guides/CHANGELOG#name-1.69.0-dotnet.2---2020-03-23-6995)
-   [\[1.69.0-dotnet.1\] - 2020-03-23](/doc/sdk/node/lts/guides/CHANGELOG#name-1.69.0-dotnet.1---2020-03-23-7005)
-   [\[1.69.0-dotnet.0\] - 2020-03-23](/doc/sdk/node/lts/guides/CHANGELOG#name-1.69.0-dotnet.0---2020-03-23-7015)
-   [\[1.68.0\] - 2020-03-06](/doc/sdk/node/lts/guides/CHANGELOG#name-1.68.0---2020-03-06-7065)
-   [\[1.68.0-dotnet.1\] - 2020-03-04](/doc/sdk/node/lts/guides/CHANGELOG#name-1.68.0-dotnet.1---2020-03-04-7075)
-   [\[1.67.1\] - 2020-02-19](/doc/sdk/node/lts/guides/CHANGELOG#name-1.67.1---2020-02-19-7165)
-   [\[1.67.0\] - 2020-02-19](/doc/sdk/node/lts/guides/CHANGELOG#name-1.67.0---2020-02-19-7175)
-   [\[1.66.1\] - 2020-01-29](/doc/sdk/node/lts/guides/CHANGELOG#name-1.66.1---2020-01-29-7315)
-   [\[1.66.0\] - 2020-01-28](/doc/sdk/node/lts/guides/CHANGELOG#name-1.66.0---2020-01-28-7335)
-   [\[1.65.2\] - 2020-01-10](/doc/sdk/node/lts/guides/CHANGELOG#name-1.65.2---2020-01-10-7387)
-   [\[1.65.1\] - 2020-01-09](/doc/sdk/node/lts/guides/CHANGELOG#name-1.65.1---2020-01-09-7397)
-   [\[1.65.0\] - 2020-01-08](/doc/sdk/node/lts/guides/CHANGELOG#name-1.65.0---2020-01-08-7407)
-   [\[1.64.2\] - 2019-11-26](/doc/sdk/node/lts/guides/CHANGELOG#name-1.64.2---2019-11-26-7622)
-   [\[1.64.0\] - 2019-11-20](/doc/sdk/node/lts/guides/CHANGELOG#name-1.64.0---2019-11-20-7632)
-   [\[1.63.2\] - 2019-11-14](/doc/sdk/node/lts/guides/CHANGELOG#name-1.63.2---2019-11-14-7647)
-   [\[1.63.1\] - 2019-11-06](/doc/sdk/node/lts/guides/CHANGELOG#name-1.63.1---2019-11-06-7667)
-   [\[1.63.0\] - 2019-10-31](/doc/sdk/node/lts/guides/CHANGELOG#name-1.63.0---2019-10-31-7702)
-   [\[1.62.0\] - 2019-10-07](/doc/sdk/node/lts/guides/CHANGELOG#name-1.62.0---2019-10-07-7772)
-   [\[1.61.3\] - 2019-10-08](/doc/sdk/node/lts/guides/CHANGELOG#name-1.61.3---2019-10-08-7782)
-   [\[1.61.2\] - 2019-09-18](/doc/sdk/node/lts/guides/CHANGELOG#name-1.61.2---2019-09-18-7792)
-   [\[1.61.1\] - 2019-09-18](/doc/sdk/node/lts/guides/CHANGELOG#name-1.61.1---2019-09-18-7807)
-   [\[1.61.0\] - 2019-09-18](/doc/sdk/node/lts/guides/CHANGELOG#name-1.61.0---2019-09-18-7817)
-   [\[1.60.0\] - 2019-08-28](/doc/sdk/node/lts/guides/CHANGELOG#name-1.60.0---2019-08-28-7842)
-   [\[1.59.0\] - 2019-08-12](/doc/sdk/node/lts/guides/CHANGELOG#name-1.59.0---2019-08-12-7877)
-   [\[1.58.0\] - 2019-07-10](/doc/sdk/node/lts/guides/CHANGELOG#name-1.58.0---2019-07-10-7902)
-   [\[1.57.0\] - 2019-06-18](/doc/sdk/node/lts/guides/CHANGELOG#name-1.57.0---2019-06-18-8042)
-   [\[1.56.0\] - 2019-05-28](/doc/sdk/node/lts/guides/CHANGELOG#name-1.56.0---2019-05-28-8087)
-   [\[1.55.0\] - 2019-04-30](/doc/sdk/node/lts/guides/CHANGELOG#name-1.55.0---2019-04-30-8220)
-   [\[1.54.6\] - 2019-04-09](/doc/sdk/node/lts/guides/CHANGELOG#name-1.54.6---2019-04-09-8226)
-   [\[1.54.2\] - 2019-04-04](/doc/sdk/node/lts/guides/CHANGELOG#name-1.54.2---2019-04-04-8232)
-   [\[1.54.1\] - 2019-04-02](/doc/sdk/node/lts/guides/CHANGELOG#name-1.54.1---2019-04-02-8242)
-   [\[1.54.0\] - 2019-04-02](/doc/sdk/node/lts/guides/CHANGELOG#name-1.54.0---2019-04-02-8252)
-   [\[1.51.0\] - 2019-01-22](/doc/sdk/node/lts/guides/CHANGELOG#name-1.51.0---2019-01-22-8327)
-   [\[1.49.1\] - 2018-12-07](/doc/sdk/node/lts/guides/CHANGELOG#name-1.49.1---2018-12-07-8362)
-   [\[1.49.0\] - 2018-11-20](/doc/sdk/node/lts/guides/CHANGELOG#name-1.49.0---2018-11-20-8382)
-   [\[1.48.0\] - 2018-10-31](/doc/sdk/node/lts/guides/CHANGELOG#name-1.48.0---2018-10-31-8432)
-   [\[1.47.7\] - 2018-10-28](/doc/sdk/node/lts/guides/CHANGELOG#name-1.47.7---2018-10-28-8457)
-   [\[1.47.6\] - 2018-10-28](/doc/sdk/node/lts/guides/CHANGELOG#name-1.47.6---2018-10-28-8460)
-   [\[1.47.5\] - 2018-10-27](/doc/sdk/node/lts/guides/CHANGELOG#name-1.47.5---2018-10-27-8470)
-   [\[1.53.0\] - 2018-03-11](/doc/sdk/node/lts/guides/CHANGELOG#name-1.53.0---2018-03-11-8480)
-   [\[1.52.0\] - 2018-02-12](/doc/sdk/node/lts/guides/CHANGELOG#name-1.52.0---2018-02-12-8535)
-   [\[1.51.5\] - 2018-02-08](/doc/sdk/node/lts/guides/CHANGELOG#name-1.51.5---2018-02-08-8538)
-   [\[1.51.4\] - 2018-02-07](/doc/sdk/node/lts/guides/CHANGELOG#name-1.51.4---2018-02-07-8553)
-   [\[1.51.3\] - 2018-02-06](/doc/sdk/node/lts/guides/CHANGELOG#name-1.51.3---2018-02-06-8578)
-   [\[1.51.2\] - 2018-01-30](/doc/sdk/node/lts/guides/CHANGELOG#name-1.51.2---2018-01-30-8593)
-   [\[1.51.1\] - 2018-01-24](/doc/sdk/node/lts/guides/CHANGELOG#name-1.51.1---2018-01-24-8603)
-   [\[1.51.0\] - 2018-01-22](/doc/sdk/node/lts/guides/CHANGELOG#name-1.51.0---2018-01-22-8618)
-   [\[1.49.1\] - 2018-12-07](/doc/sdk/node/lts/guides/CHANGELOG#name-1.49.1---2018-12-07-8653)
-   [\[1.49.0\] - 2018-11-20](/doc/sdk/node/lts/guides/CHANGELOG#name-1.49.0---2018-11-20-8673)
-   [\[1.48.0\] - 2018-10-31](/doc/sdk/node/lts/guides/CHANGELOG#name-1.48.0---2018-10-31-8723)
-   [\[1.47.7\] - 2018-10-28](/doc/sdk/node/lts/guides/CHANGELOG#name-1.47.7---2018-10-28-8748)
-   [\[1.47.6\] - 2018-10-28](/doc/sdk/node/lts/guides/CHANGELOG#name-1.47.6---2018-10-28-8751)
-   [\[1.47.5\] - 2018-10-27](/doc/sdk/node/lts/guides/CHANGELOG#name-1.47.5---2018-10-27-8761)
-   [\[1.47.0\] - 2018-10-10](/doc/sdk/node/lts/guides/CHANGELOG#name-1.47.0---2018-10-10-8771)
-   [\[1.46.0\] - 2018-09-07](/doc/sdk/node/lts/guides/CHANGELOG#name-1.46.0---2018-09-07-8821)
-   [\[1.45.1\] - 2018-09-07](/doc/sdk/node/lts/guides/CHANGELOG#name-1.45.1---2018-09-07-8841)
-   [\[1.45.0\] - 2018-08-28](/doc/sdk/node/lts/guides/CHANGELOG#name-1.45.0---2018-08-28-8886)
-   [\[1.44.0\] - 2018-08-03](/doc/sdk/node/lts/guides/CHANGELOG#name-1.44.0---2018-08-03-8916)
-   [\[1.43.4\] - 2018-07-21](/doc/sdk/node/lts/guides/CHANGELOG#name-1.43.4---2018-07-21-8936)
-   [\[1.43.3\] - 2018-07-19](/doc/sdk/node/lts/guides/CHANGELOG#name-1.43.3---2018-07-19-8946)
-   [\[1.43.2\] - 2018-07-13](/doc/sdk/node/lts/guides/CHANGELOG#name-1.43.2---2018-07-13-8956)
-   [\[1.43.1\] - 2018-07-12](/doc/sdk/node/lts/guides/CHANGELOG#name-1.43.1---2018-07-12-8966)
-   [\[1.42.3\] - 2018-06-25](/doc/sdk/node/lts/guides/CHANGELOG#name-1.42.3---2018-06-25-9001)
-   [\[1.42.2\] - 2018-06-21](/doc/sdk/node/lts/guides/CHANGELOG#name-1.42.2---2018-06-21-9021)
-   [\[1.42.1\] - 2018-06-20](/doc/sdk/node/lts/guides/CHANGELOG#name-1.42.1---2018-06-20-9031)
-   [\[1.42.0\] - 2018-06-20](/doc/sdk/node/lts/guides/CHANGELOG#name-1.42.0---2018-06-20-9041)
-   [\[1.41.6\] - 2018-06-07](/doc/sdk/node/lts/guides/CHANGELOG#name-1.41.6---2018-06-07-9061)
-   [\[1.41.5\] - 2018-06-06](/doc/sdk/node/lts/guides/CHANGELOG#name-1.41.5---2018-06-06-9071)
-   [\[1.41.4\] - 2018-06-05](/doc/sdk/node/lts/guides/CHANGELOG#name-1.41.4---2018-06-05-9081)
-   [\[1.41.3\] - 2018-05-30](/doc/sdk/node/lts/guides/CHANGELOG#name-1.41.3---2018-05-30-9091)
-   [\[1.41.2\] - 2018-05-30](/doc/sdk/node/lts/guides/CHANGELOG#name-1.41.2---2018-05-30-9106)
-   [\[1.41.1\] - 2018-05-30](/doc/sdk/node/lts/guides/CHANGELOG#name-1.41.1---2018-05-30-9116)
-   [\[1.41.0\] - 2018-05-28](/doc/sdk/node/lts/guides/CHANGELOG#name-1.41.0---2018-05-28-9126)
-   [\[1.40.2\] - 2018-05-18](/doc/sdk/node/lts/guides/CHANGELOG#name-1.40.2---2018-05-18-9146)
-   [\[1.40.1\] - 2018-05-03](/doc/sdk/node/lts/guides/CHANGELOG#name-1.40.1---2018-05-03-9161)
-   [\[1.40.0\] - 2018-05-02](/doc/sdk/node/lts/guides/CHANGELOG#name-1.40.0---2018-05-02-9171)
-   [\[1.39.1\] - 2018-04-12](/doc/sdk/node/lts/guides/CHANGELOG#name-1.39.1---2018-04-12-9196)
-   [\[1.39.0\] - 2018-04-09](/doc/sdk/node/lts/guides/CHANGELOG#name-1.39.0---2018-04-09-9206)
-   [\[1.38.0\] - 2018-03-17](/doc/sdk/node/lts/guides/CHANGELOG#name-1.38.0---2018-03-17-9236)
-   [\[1.37.0\] - 2018-02-25](/doc/sdk/node/lts/guides/CHANGELOG#name-1.37.0---2018-02-25-9251)
-   [\[1.36.1\] - 2018-02-03](/doc/sdk/node/lts/guides/CHANGELOG#name-1.36.1---2018-02-03-9271)
-   [\[1.36.0\] - 2018-02-02](/doc/sdk/node/lts/guides/CHANGELOG#name-1.36.0---2018-02-02-9281)
-   [\[1.35.2\] - 2018-01-18](/doc/sdk/node/lts/guides/CHANGELOG#name-1.35.2---2018-01-18-9341)
-   [\[1.35.1\] - 2018-01-12](/doc/sdk/node/lts/guides/CHANGELOG#name-1.35.1---2018-01-12-9351)
-   [\[1.35.0\] - 2018-01-11](/doc/sdk/node/lts/guides/CHANGELOG#name-1.35.0---2018-01-11-9361)
-   [\[1.34.0\] - 2017-12-17](/doc/sdk/node/lts/guides/CHANGELOG#name-1.34.0---2017-12-17-9391)
-   [\[1.33.3\] - 2017-12-01](/doc/sdk/node/lts/guides/CHANGELOG#name-1.33.3---2017-12-01-9421)
-   [\[1.33.2\] - 2017-11-30](/doc/sdk/node/lts/guides/CHANGELOG#name-1.33.2---2017-11-30-9431)
-   [\[1.33.1\] - 2017-11-28](/doc/sdk/node/lts/guides/CHANGELOG#name-1.33.1---2017-11-28-9441)
-   [\[1.33.0\] - 2017-11-24](/doc/sdk/node/lts/guides/CHANGELOG#name-1.33.0---2017-11-24-9466)
-   [\[1.32.0\] - 2017-11-04](/doc/sdk/node/lts/guides/CHANGELOG#name-1.32.0---2017-11-04-9486)
-   [\[1.31.1\] - 2017-10-17](/doc/sdk/node/lts/guides/CHANGELOG#name-1.31.1---2017-10-17-9521)
-   [\[1.31.0\] - 2017-09-28](/doc/sdk/node/lts/guides/CHANGELOG#name-1.31.0---2017-09-28-9546)
-   [\[1.30.2\] - 2017-09-28](/doc/sdk/node/lts/guides/CHANGELOG#name-1.30.2---2017-09-28-9611)
-   [\[1.30.1\] - 2017-09-17](/doc/sdk/node/lts/guides/CHANGELOG#name-1.30.1---2017-09-17-9621)
-   [\[1.30.0\] - 2017-09-07](/doc/sdk/node/lts/guides/CHANGELOG#name-1.30.0---2017-09-07-9651)
-   [\[1.29.4\] - 2017-08-23](/doc/sdk/node/lts/guides/CHANGELOG#name-1.29.4---2017-08-23-9666)
-   [\[1.29.3\] - 2017-08-22](/doc/sdk/node/lts/guides/CHANGELOG#name-1.29.3---2017-08-22-9676)
-   [\[1.29.2\] - 2017-08-18](/doc/sdk/node/lts/guides/CHANGELOG#name-1.29.2---2017-08-18-9696)
-   [\[1.29.1\] - 2017-08-17](/doc/sdk/node/lts/guides/CHANGELOG#name-1.29.1---2017-08-17-9706)
-   [\[1.29.0\] - 2017-08-16](/doc/sdk/node/lts/guides/CHANGELOG#name-1.29.0---2017-08-16-9716)
-   [\[1.28.0\] - 2017-07-22](/doc/sdk/node/lts/guides/CHANGELOG#name-1.28.0---2017-07-22-9771)
-   [\[1.27.2\] - 2017-06-30](/doc/sdk/node/lts/guides/CHANGELOG#name-1.27.2---2017-06-30-9836)
-   [\[1.27.1\] - 2017-06-28](/doc/sdk/node/lts/guides/CHANGELOG#name-1.27.1---2017-06-28-9846)
-   [\[1.27.0\] - 2017-06-26](/doc/sdk/node/lts/guides/CHANGELOG#name-1.27.0---2017-06-26-9856)
-   [\[0.10.18\] - 2017-06-09](/doc/sdk/node/lts/guides/CHANGELOG#name-0.10.18---2017-06-09-9901)
-   [\[0.10.15\] - 2017-05-23](/doc/sdk/node/lts/guides/CHANGELOG#name-0.10.15---2017-05-23-9911)
-   [\[0.10.14\] - 2017-05-19](/doc/sdk/node/lts/guides/CHANGELOG#name-0.10.14---2017-05-19-9921)
-   [\[0.10.13\] - 2017-05-04](/doc/sdk/node/lts/guides/CHANGELOG#name-0.10.13---2017-05-04-9941)
-   [\[0.10.12\] - 2017-04-30](/doc/sdk/node/lts/guides/CHANGELOG#name-0.10.12---2017-04-30-9951)
-   [\[0.9.7\] - 2017-03-21](/doc/sdk/node/lts/guides/CHANGELOG#name-0.9.7---2017-03-21-10001)
-   [\[0.8.12\] - 2017-03-14](/doc/sdk/node/lts/guides/CHANGELOG#name-0.8.12---2017-03-14-10011)
-   [\[0.7.3\] - 2017-03-02](/doc/sdk/node/lts/guides/CHANGELOG#name-0.7.3---2017-03-02-10036)
-   [\[0.6.7\] - 2017-03-01](/doc/sdk/node/lts/guides/CHANGELOG#name-0.6.7---2017-03-01-10046)
-   [\[0.5.6\] - 2017-02-24](/doc/sdk/node/lts/guides/CHANGELOG#name-0.5.6---2017-02-24-10056)
-   [\[0.4.8\] - 2017-02-22](/doc/sdk/node/lts/guides/CHANGELOG#name-0.4.8---2017-02-22-10071)
-   [\[0.3.8\] - 2017-02-21](/doc/sdk/node/lts/guides/CHANGELOG#name-0.3.8---2017-02-21-10086)
-   [\[0.0.2\] - 2017-02-21](/doc/sdk/node/lts/guides/CHANGELOG#name-0.0.2---2017-02-21-10101)
-   [\[0.0.1\] - 2017-02-19](/doc/sdk/node/lts/guides/CHANGELOG#name-0.0.1---2017-02-19-10116)

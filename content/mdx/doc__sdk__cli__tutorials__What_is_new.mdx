...
description: ""
type: "sdk"
source: "https://developers.openrainbow.com/doc/sdk/cli/tutorials/What_is_new"
lastSynced: "2026-02-20T07:12:29.018Z"
---
# Documentation
...
-   Correction for application filtering by type
-   Documentation corrections

### Rainbow CLI 1.99 (July 2022)
...
-   New command `rbw application create baidu` to configure Baidu push notification service (for Android)

### Rainbow CLI 1.98 (January 2022)
...
-   Corrected issue with `rbw company metrics --json` command never exiting
-   Forced colors dependency to 1.4.0 to avoid display issue in colors 1.4.2

### Rainbow CLI 1.94 (October 2021)
...
-   Fix in `rbw users` command
-   Updated Rainbow NodeSDK

### Rainbow CLI 1.89 (June 2021)
...
-   New command to list applications with an expired push certificate 'rbw applications expired certificates'

### Rainbow CLI 1.87 (April 2021)
...
-   New commands to create fcm xmpp (Android) and apns v2 (iOS) push notification configuration
-   Updated NodeSDK
...
-   New commands for application thresholds: `rbw application thresholds` to list thresholds, `rbw application threshold` to create a custom threshold, `rbw application threshold update` to update a custom threshold, `rbw application threshold delete` to delete a custom threshold.
...
-   [Rainbow CLI: What's new](/docs/sdk/cli/tutorials/What_is_new#name-rainbow-cli:-whats-new-0)
-   [Rainbow CLI 1.100 (August 2022)](/docs/sdk/cli/tutorials/What_is_new#name-rainbow-cli-1.100-august-2022-7)
-   [Rainbow CLI 1.99 (July 2022)](/docs/sdk/cli/tutorials/What_is_new#name-rainbow-cli-1.99-july-2022-46)
-   [Rainbow CLI 1.98 (January 2022)](/docs/sdk/cli/tutorials/What_is_new#name-rainbow-cli-1.98-january-2022-80)
-   [Rainbow CLI 1.94 (October 2021)](/docs/sdk/cli/tutorials/What_is_new#name-rainbow-cli-1.94-october-2021-119)
-   [Rainbow CLI 1.89 (June 2021)](/docs/sdk/cli/tutorials/What_is_new#name-rainbow-cli-1.89-june-2021-158)
-   [Rainbow CLI 1.87 (April 2021)](/docs/sdk/cli/tutorials/What_is_new#name-rainbow-cli-1.87-april-2021-192)
-   [Rainbow CLI 1.81 (December 2020)](/docs/sdk/cli/tutorials/What_is_new#name-rainbow-cli-1.81-december-2020-231)
-   [Rainbow CLI 1.71 (April 2020)](/docs/sdk/cli/tutorials/What_is_new#name-rainbow-cli-1.71-april-2020-275)
-   [Rainbow CLI 1.70 (April 2020)](/docs/sdk/cli/tutorials/What_is_new#name-rainbow-cli-1.70-april-2020-314)
-   [Rainbow CLI 1.69 (March 2020)](/docs/sdk/cli/tutorials/What_is_new#name-rainbow-cli-1.69-march-2020-348)
-   [Rainbow CLI 1.67 (February 2020)](/docs/sdk/cli/tutorials/What_is_new#name-rainbow-cli-1.67-february-2020-387)
-   [Rainbow CLI 1.65 (December 2019)](/docs/sdk/cli/tutorials/What_is_new#name-rainbow-cli-1.65-december-2019-397)
-   [Rainbow CLI 1.59 (July 2019)](/docs/sdk/cli/tutorials/What_is_new#name-rainbow-cli-1.59-july-2019-431)
-   [Rainbow CLI 1.56 (June 2019)](/docs/sdk/cli/tutorials/What_is_new#name-rainbow-cli-1.56-june-2019-475)
-   [Rainbow CLI 1.55 (April 2019)](/docs/sdk/cli/tutorials/What_is_new#name-rainbow-cli-1.55-april-2019-519)
-   [Rainbow CLI 1.54 (April 2019) - Beta](/docs/sdk/cli/tutorials/What_is_new#name-rainbow-cli-1.54-april-2019---beta-568)
-   [Rainbow CLI 1.53 (Mars 2019) - Beta](/docs/sdk/cli/tutorials/What_is_new#name-rainbow-cli-1.53-mars-2019---beta-627)
-   [Rainbow CLI 1.52 (February 2019) - Beta](/docs/sdk/cli/tutorials/What_is_new#name-rainbow-cli-1.52-february-2019---beta-681)
-   [Rainbow CLI 1.51 (January 2019) - Beta](/docs/sdk/cli/tutorials/What_is_new#name-rainbow-cli-1.51-january-2019---beta-725)
-   [Rainbow CLI 1.50 (December 2018) - Beta](/docs/sdk/cli/tutorials/What_is_new#name-rainbow-cli-1.50-december-2018---beta-779)
-   [Rainbow CLI 1.49 (November 2018) - Beta](/docs/sdk/cli/tutorials/What_is_new#name-rainbow-cli-1.49-november-2018---beta-828)
-   [Rainbow CLI 1.48 (October 2018) - Beta](/docs/sdk/cli/tutorials/What_is_new#name-rainbow-cli-1.48-october-2018---beta-872)
-   [Rainbow CLI 1.47 (October 2018) - Beta](/docs/sdk/cli/tutorials/What_is_new#name-rainbow-cli-1.47-october-2018---beta-921)
-   [Rainbow CLI 1.46 (September 2018) - Beta](/docs/sdk/cli/tutorials/What_is_new#name-rainbow-cli-1.46-september-2018---beta-965)
-   [Rainbow CLI 1.45 (August 2018) - Beta](/docs/sdk/cli/tutorials/What_is_new#name-rainbow-cli-1.45-august-2018---beta-1019)
-   [Rainbow CLI 1.44 (July 2018) - Beta](/docs/sdk/cli/tutorials/What_is_new#name-rainbow-cli-1.44-july-2018---beta-1068)
-   [Rainbow CLI 1.43 (July 2018) - Beta](/docs/sdk/cli/tutorials/What_is_new#name-rainbow-cli-1.43-july-2018---beta-1122)
-   [Rainbow CLI 1.42 (June 2018) - Beta](/docs/sdk/cli/tutorials/What_is_new#name-rainbow-cli-1.42-june-2018---beta-1191)
-   [Rainbow CLI 1.41 (May 2018) - Beta](/docs/sdk/cli/tutorials/What_is_new#name-rainbow-cli-1.41-may-2018---beta-1250)
-   [Rainbow CLI 1.40 (Avril 2018) - Beta](/docs/sdk/cli/tutorials/What_is_new#name-rainbow-cli-1.40-avril-2018---beta-1309)
-   [Rainbow CLI 1.39 (Avril 2018) - Beta](/docs/sdk/cli/tutorials/What_is_new#name-rainbow-cli-1.39-avril-2018---beta-1378)
-   [Rainbow CLI 1.38 (March 2018) - Beta](/docs/sdk/cli/tutorials/What_is_new#name-rainbow-cli-1.38-march-2018---beta-1442)
-   [Rainbow CLI 1.37 (March 2018) - Beta](/docs/sdk/cli/tutorials/What_is_new#name-rainbow-cli-1.37-march-2018---beta-1506)
-   [Rainbow CLI 1.36 (February 2018) - Beta](/docs/sdk/cli/tutorials/What_is_new#name-rainbow-cli-1.36-february-2018---beta-1603)
-   [Rainbow CLI 1.35 (January 2018) - Beta](/docs/sdk/cli/tutorials/What_is_new#name-rainbow-cli-1.35-january-2018---beta-1662)
-   [Rainbow CLI 1.34 (Decembre 2017) - Beta](/docs/sdk/cli/tutorials/What_is_new#name-rainbow-cli-1.34-decembre-2017---beta-1709)
-   [Rainbow CLI 1.33 (November 2017) - Beta](/docs/sdk/cli/tutorials/What_is_new#name-rainbow-cli-1.33-november-2017---beta-1758)
-   [Rainbow CLI 1.32 (November 2017) - Beta](/docs/sdk/cli/tutorials/What_is_new#name-rainbow-cli-1.32-november-2017---beta-1787)
-   [Rainbow CLI 1.31 (October 2017) - Beta](/docs/sdk/cli/tutorials/What_is_new#name-rainbow-cli-1.31-october-2017---beta-1841)
-   [Rainbow CLI 1.30 (September 2017) - Beta](/docs/sdk/cli/tutorials/What_is_new#name-rainbow-cli-1.30-september-2017---beta-1865)
-   [Rainbow CLI 0.8 (August 2017) - Beta](/docs/sdk/cli/tutorials/What_is_new#name-rainbow-cli-0.8-august-2017---beta-1889)

...
description: ""
type: "sdk"
source: "https://developers.openrainbow.com/doc/sdk/node/lts/guides/Debugging"
lastSynced: "2026-02-20T07:12:33.048Z"
---
# Documentation
...
You can disable it by setting the parameter `enableConsoleLogs` to `false`. You can add a custom label added in logs (helpful when multiple instances of sdk are running)
...
The SDK Services that generated this log

**Method**

`constructor`

The SDK method that generated this log
...
-   [Debugging](/docs/sdk/node#name-debugging-0)
-   [Preamble](/docs/sdk/node#name-preamble-4)
-   [Retrieving SDK version](/docs/sdk/node#name-retrieving-sdk-version-14)
-   [Configuring logs](/docs/sdk/node#name-configuring-logs-25)
-   [Console logger](/docs/sdk/node#name-console-logger-32)
-   [Files logger](/docs/sdk/node#name-files-logger-80)
-   [Disk usage](/docs/sdk/node#name-disk-usage-109)
-   [Retrieving information in logs](/docs/sdk/node#name-retrieving-information-in-logs-133)
-   [Specific version information](/docs/sdk/node#name-specific-version-information-219)

...
description: ""
type: "sdk"
source: "https://developers.openrainbow.com/doc/sdk/node/lts/guides/Retrieving_calls_history"
lastSynced: "2026-02-20T07:12:33.240Z"
---
# Documentation
...
-   [Retrieving calls history](/docs/sdk/node#name-retrieving-calls-history-0)
-   [Preamble](/docs/sdk/node#name-preamble-10)
-   [Retrieving the call history](/docs/sdk/node#name-retrieving-the-call-history-54)
-   [Listening to new call history entry](/docs/sdk/node#name-listening-to-new-call-history-entry-71)
-   [Managing call history counter](/docs/sdk/node#name-managing-call-history-counter-81)
-   [Mark a call history entry as read](/docs/sdk/node#name-mark-a-call-history-entry-as-read-98)
-   [Deleting call history items](/docs/sdk/node#name-deleting-call-history-items-118)
-   [Limits](/docs/sdk/node#name-limits-132)

...
description: ""
type: "sdk"
source: "https://developers.openrainbow.com/doc/sdk/node/lts/guides/Getting_Started"
lastSynced: "2026-02-20T07:12:33.077Z"
---
# Documentation
...
**Active LTS version only is supported**

Starting 10.x (without support)

NPM

**Active LTS version is supported**

Starting 6.x (without support)
...
To obtain it, you have to connect to the [Rainbow for Developers](/) and to follow the instructions.
...
If you don't have valids application `id` and `secret`, you can create it with the rainbow-cli (github) tool. They are mandatory.
...
-   [SDK for Node.JS: Getting Started](/docs/sdk/node#name-sdk-for-node.js:-getting-started-0)
-   [Preamble](/docs/sdk/node#name-preamble-4)
-   [Prerequisites](/docs/sdk/node#name-prerequisites-20)
-   [Node.JS and NPM](/docs/sdk/node#name-node.js-and-npm-24)
-   [Platforms supported](/docs/sdk/node#name-platforms-supported-76)
-   [For developping using the Rainbow Developers Sandboxed Platform](/docs/sdk/node#name-for-developping-using-the-rainbow-developers-sandboxed-platform-121)
-   [For deploying in the Rainbow Production environment](/docs/sdk/node#name-for-deploying-in-the-rainbow-production-environment-143)
-   [Building a new Node.JS application](/docs/sdk/node#name-building-a-new-node.js-application-153)
-   [Initializing your application](/docs/sdk/node#name-initializing-your-application-160)
-   [Installing the ALE Rainbow SDK for Node.JS](/docs/sdk/node#name-installing-the-ale-rainbow-sdk-for-node.js-171)
-   [Loading and starting the SDK](/docs/sdk/node#name-loading-and-starting-the-sdk-182)
-   [Configuring your SDK (in XMPP mode)](/docs/sdk/node#name-configuring-your-sdk-in-xmpp-mode-200)
-   [Executing the application](/docs/sdk/node#name-executing-the-application-217)
-   [Listening to SDK events](/docs/sdk/node#name-listening-to-sdk-events-232)

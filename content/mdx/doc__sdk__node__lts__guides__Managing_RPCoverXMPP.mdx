...
description: ""
type: "sdk"
source: "https://developers.openrainbow.com/doc/sdk/node/lts/guides/Managing_RPCoverXMPP"
lastSynced: "2026-02-20T07:12:33.195Z"
---
# Documentation

Managing RPC over XMPP
...
Once started, you can manage the RPC Service. You can add or remove RPC methods in the RPC engine. The methods shared by the server are qualified by properties :

-   **`methodName`** {string} The name of the method to be added in RPC server. This is the name used by the RPC Client to call it.
-   **`methodCallback`** {string} The callback of the method to be added in RPC server.  
...
-   **system.methodSignature** This method returns a description of the argument format a particular method expects.  
...
-   **system.methodHelp** This method returns a text description of a particular method.  
    The method takes one parameter, an XML-RPC string. Its value is the name of the XML-RPC method about which information is being requested.
...
-   [Managing Remote Procedure Call over XMPP](/docs/sdk/node#name-managing-remote-procedure-call-over-xmpp-0)
-   [Preamble](/docs/sdk/node#name-preamble-4)
-   [RPC Server](/docs/sdk/node#name-rpc-server-15)
-   [Manage RPC Service](/docs/sdk/node#name-manage-rpc-service-69)
-   [RPC Client features](/docs/sdk/node#name-rpc-client-features-89)

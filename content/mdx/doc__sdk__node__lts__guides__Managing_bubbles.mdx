...
description: ""
type: "sdk"
source: "https://developers.openrainbow.com/doc/sdk/node/lts/guides/Managing_bubbles"
lastSynced: "2026-02-20T07:12:33.114Z"
---
# Documentation
...
Please note that there is some limits regarding the custom data to avoid abuse. To consult the exact limits concerning the Rainbow Bubbles, visit [this link](/docs/hub/features-limits)
...
The member is an active member in the bubble and so can send and receive messages
...
The member has left the bubble (by his own or by a moderator)
...
A member who has been invited with a role of **moderator** can administrate the bubble (eg. Inviting others Rainbow users, renaming the bubble's name and description information, close and delete the bubble...) and collaborate with others members

**Participant**

A member who has been invited with a role of **participant** can only collaborate with others members (eg. chatting, sharing files and so can't do administrative tasks in that Bubble
...
*Last updated April, 04th 2017*

### On this page

-   [Managing Bubbles](/docs/sdk/node#name-managing-bubbles-0)
-   [Preamble](/docs/sdk/node#name-preamble-4)
-   [Retrieve the list of existing bubbles](/docs/sdk/node#name-retrieve-the-list-of-existing-bubbles-11)
-   [Retrieve a bubble information](/docs/sdk/node#name-retrieve-a-bubble-information-25)
-   [Create a new Bubble](/docs/sdk/node#name-create-a-new-bubble-33)
-   [Inviting a Rainbow user to a bubble](/docs/sdk/node#name-inviting-a-rainbow-user-to-a-bubble-50)
-   [Inviting a Rainbow user to a bubble as a moderator](/docs/sdk/node#name-inviting-a-rainbow-user-to-a-bubble-as-a-moderator-61)
-   [Inviting users by email to a bubble](/docs/sdk/node#name-inviting-users-by-email-to-a-bubble-73)
-   [Adding a Rainbow user to a bubble](/docs/sdk/node#name-adding-a-rainbow-user-to-a-bubble-81)
-   [Remove a contact from a bubble](/docs/sdk/node#name-remove-a-contact-from-a-bubble-95)
-   [Setting custom data to a Bubble](/docs/sdk/node#name-setting-custom-data-to-a-bubble-109)
-   [Modifying custom data of a Bubble](/docs/sdk/node#name-modifying-custom-data-of-a-bubble-126)
-   [Modifying the name of the bubble](/docs/sdk/node#name-modifying-the-name-of-the-bubble-137)
-   [Modifying the topic of the bubble](/docs/sdk/node#name-modifying-the-topic-of-the-bubble-145)
-   [Be notified when custom data have been modified](/docs/sdk/node#name-be-notified-when-custom-data-have-been-modified-153)
-   [Be notified when the name of the bubble has been modified](/docs/sdk/node#name-be-notified-when-the-name-of-the-bubble-has-been-modified-164)
-   [Be notified when the topic of the bubble has been modified](/docs/sdk/node#name-be-notified-when-the-topic-of-the-bubble-has-been-modified-175)
-   [Be notified when a contact changes his affiliation with a bubble](/docs/sdk/node#name-be-notified-when-a-contact-changes-his-affiliation-with-a-bubble-186)
-   [Be notified when the affiliation of the connected user changes with a bubble](/docs/sdk/node#name-be-notified-when-the-affiliation-of-the-connected-user-changes-with-a-bubble-197)
-   [Leaving a bubble](/docs/sdk/node#name-leaving-a-bubble-208)
-   [Closing a bubble](/docs/sdk/node#name-closing-a-bubble-234)
-   [Deleting a bubble](/docs/sdk/node#name-deleting-a-bubble-251)
-   [Be notified when a request to join a bubble is received](/docs/sdk/node#name-be-notified-when-a-request-to-join-a-bubble-is-received-265)
-   [Accepting a request to join a bubble](/docs/sdk/node#name-accepting-a-request-to-join-a-bubble-273)
-   [Declining a request to join a bubble](/docs/sdk/node#name-declining-a-request-to-join-a-bubble-284)
-   [Get the list of pending invitation to join a bubble](/docs/sdk/node#name-get-the-list-of-pending-invitation-to-join-a-bubble-292)
-   [Understanding members status and privilege in a Bubble](/docs/sdk/node#name-understanding-members-status-and-privilege-in-a-bubble-306)
-   [Status of a member](/docs/sdk/node#name-status-of-a-member-328)
-   [Privilege of a member](/docs/sdk/node#name-privilege-of-a-member-392)
-   [Limits](/docs/sdk/node#name-limits-435)

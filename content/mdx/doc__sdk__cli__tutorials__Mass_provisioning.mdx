...
description: ""
type: "sdk"
source: "https://developers.openrainbow.com/doc/sdk/cli/tutorials/Mass_provisioning"
lastSynced: "2026-02-20T07:12:28.986Z"
---
# Documentation
...
This is the action of importing to Rainbow a list of users to provision from an input file (ie: generally a CSV file).

**CSV template**

To ease the provisionning, you can download a template file that is in fact a sample of file that can be importing. In this sample, you will have an example of how to add a new user, how to remove it, etc...
...
-   [Mass provisioning](/docs/sdk/cli/tutorials/Mass_provisioning#name-mass-provisioning-0)
-   [Preamble](/docs/sdk/cli/tutorials/Mass_provisioning#name-preamble-4)
-   [Rainbow Knowledge](/docs/sdk/cli/tutorials/Mass_provisioning#name-rainbow-knowledge-14)
-   [Getting the mass-provisioning template](/docs/sdk/cli/tutorials/Mass_provisioning#name-getting-the-mass-provisioning-template-51)
-   [Understanding the template file](/docs/sdk/cli/tutorials/Mass_provisioning#name-understanding-the-template-file-88)
-   [Checking your CSV file](/docs/sdk/cli/tutorials/Mass_provisioning#name-checking-your-csv-file-136)
-   [Importing your CSV file](/docs/sdk/cli/tutorials/Mass_provisioning#name-importing-your-csv-file-150)
-   [Checking the list of operations done](/docs/sdk/cli/tutorials/Mass_provisioning#name-checking-the-list-of-operations-done-190)
-   [Display detailled information of an operation](/docs/sdk/cli/tutorials/Mass_provisioning#name-display-detailled-information-of-an-operation-204)
-   [Remove an operation report](/docs/sdk/cli/tutorials/Mass_provisioning#name-remove-an-operation-report-215)
-   [Interested in](/docs/sdk/cli/tutorials/Mass_provisioning#name-interested-in-229)

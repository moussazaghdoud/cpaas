...
description: ""
type: "sdk"
source: "https://developers.openrainbow.com/doc/sdk/node/lts/guides/Managing_conferences"
lastSynced: "2026-02-20T07:12:33.144Z"
---
# Documentation
...
To get current conferences you can call the `BubblesService::retrieveConferences` API. The WebRTC conferences can not be joined from node SDK because a WebRTC stack is need, and none is integrated in it. So it has to be done from common UI.
...
*Last updated december, 08th 2022*

### On this page

-   [Managing Conferences](/docs/sdk/node#name-managing-conferences-0)
-   [Preamble](/docs/sdk/node#name-preamble-4)
-   [Managing conferences](/docs/sdk/node#name-managing-conferences-11)
-   [Check permissions](/docs/sdk/node#name-check-permissions-23)
-   [WebRTC conferences](/docs/sdk/node#name-webrtc-conferences-31)
-   [Follow conference update - WebRTC](/docs/sdk/node#name-follow-conference-update---webrtc-38)
-   [Limits](/docs/sdk/node#name-limits-69)

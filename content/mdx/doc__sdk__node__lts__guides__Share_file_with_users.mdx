...
description: ""
type: "sdk"
source: "https://developers.openrainbow.com/doc/sdk/node/lts/guides/Share_file_with_users"
lastSynced: "2026-02-20T07:12:33.256Z"
---
# Documentation
...
-   [Sharing files](/docs/sdk/node#name-sharing-files-0)
-   [Preamble](/docs/sdk/node#name-preamble-10)
-   [Knowing the file sharing quota](/docs/sdk/node#name-knowing-the-file-sharing-quota-112)
-   [Sharing a file with a Rainbow user](/docs/sdk/node#name-sharing-a-file-with-a-rainbow-user-127)
-   [Sharing a file within a Bubble](/docs/sdk/node#name-sharing-a-file-within-a-bubble-138)
-   [Be notified of a new file shared](/docs/sdk/node#name-be-notified-of-a-new-file-shared-146)
-   [Downloading a file or for an image, put it in IMG Tag](/docs/sdk/node#name-downloading-a-file-or-for-an-image-put-it-in-img-tag-162)
-   [Removing a file shared](/docs/sdk/node#name-removing-a-file-shared-177)
-   [Retrieving the files sent and received in a conversation](/docs/sdk/node#name-retrieving-the-files-sent-and-received-in-a-conversation-185)
-   [Retrieving the files sent and received in a bubble](/docs/sdk/node#name-retrieving-the-files-sent-and-received-in-a-bubble-193)
-   [Retrieving the whole list of files sent](/docs/sdk/node#name-retrieving-the-whole-list-of-files-sent-201)

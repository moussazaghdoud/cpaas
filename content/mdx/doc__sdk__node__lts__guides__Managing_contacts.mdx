...
description: ""
type: "sdk"
source: "https://developers.openrainbow.com/doc/sdk/node/lts/guides/Managing_contacts"
lastSynced: "2026-02-20T07:12:33.159Z"
---
# Documentation
...
The contact is not connected to a Rainbow based application or is invisible

**online**

The contact is connected to Rainbow using at least a desktop application

**online**

**mobile**

The contact is connected to Rainbow using a mobile application only

**away**

The contact doesn't use the application since a while

**busy**

The contact has manually asked to be not disturbed

**busy**

**phone**

The contact is engaging in a phone call

**busy**

**audio** or **video**

The contact is engaging to an audio or video call

**busy**

**sharing**

The contact is engaging to a screen sharing call

**busy**

**presentation**

The contact is using an application in full screen mode
...
*Note*: Availability of a contact that is not in your network is not known. `presence` is set to `unknown` for that case.
...
*Note*: Depending the visibility of this user, the vcard can be reduced to a minimal set of information. See the guide [Users visibility and privacy](/docs/hub/users-visibility-and-privacy) to have more information on that topic.
...
So take care using this API because you can have no result even is a contact with this `loginEmail` exists. See the guide [Users visibility and privacy](/docs/hub/users-visibility-and-privacy) to have more information on that topic.
...
-   [Managing Contacts](/docs/sdk/node#name-managing-contacts-0)
-   [Preamble](/docs/sdk/node#name-preamble-4)
-   [Accessing to your account](/docs/sdk/node#name-accessing-to-your-account-14)
-   [Accessing to contacts in your network](/docs/sdk/node#name-accessing-to-contacts-in-your-network-52)
-   [Understanding network's contacts availability](/docs/sdk/node#name-understanding-networks-contacts-availability-84)
-   [Presence and Status](/docs/sdk/node#name-presence-and-status-111)
-   [Resources](/docs/sdk/node#name-resources-240)
-   [Listening when a contact availability changes](/docs/sdk/node#name-listening-when-a-contact-availability-changes-259)
-   [Search a contact by ID](/docs/sdk/node#name-search-a-contact-by-id-267)
-   [Search a contact by JID](/docs/sdk/node#name-search-a-contact-by-jid-281)
-   [Search a contact by loginEmail](/docs/sdk/node#name-search-a-contact-by-loginemail-295)

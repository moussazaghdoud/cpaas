...
description: ""
type: "sdk"
source: "https://developers.openrainbow.com/doc/sdk/node/lts/guides/Answering_chat_message"
lastSynced: "2026-02-20T07:12:32.821Z"
---
# Documentation
...
You can have more details about the `message` structure by looking to the [Message API documentation](/docs/sdk/node).
...
Your message has been successfully received by Rainbow. It will now be relayed to the recipient

`received`

`rainbow_onmessagereceiptreceived`

Your message has been successfully received by the recipient application
...
A member left or has been removed from the bubble by a moderator

**invitation**

A member has been invited to the bubble - received only by the **moderator**

**join**

A new member has join the bubble
...
You have been granted to the bubble - received only by the **user who enters the bubble**
...
You can't send chat message having more than 1024 characters. This limit takes into account any additionnal content message.
...
-   [Answering to Chat Messages](/docs/sdk/node#name-answering-to-chat-messages-0)
-   [Preamble](/docs/sdk/node#name-preamble-4)
-   [Listening to incoming messages](/docs/sdk/node#name-listening-to-incoming-messages-14)
-   [Listening to incoming messages coming from a user](/docs/sdk/node#name-listening-to-incoming-messages-coming-from-a-user-21)
-   [Listening to incoming messages sending to a bubble](/docs/sdk/node#name-listening-to-incoming-messages-sending-to-a-bubble-32)
-   [Answering to messages](/docs/sdk/node#name-answering-to-messages-46)
-   [Managing received receipts](/docs/sdk/node#name-managing-received-receipts-53)
-   [Sending read receipts automatically](/docs/sdk/node#name-sending-read-receipts-automatically-63)
-   [Sending read receipt manually](/docs/sdk/node#name-sending-read-receipt-manually-77)
-   [Sending a message to a recipient](/docs/sdk/node#name-sending-a-message-to-a-recipient-88)
-   [Sending a message to a bubble](/docs/sdk/node#name-sending-a-message-to-a-bubble-102)
-   [Replying to specific message to a recipient](/docs/sdk/node#name-replying-to-specific-message-to-a-recipient-113)
-   [Replying to a specific message to a bubble](/docs/sdk/node#name-replying-to-a-specific-message-to-a-bubble-121)
-   [Send a typing state to receipts](/docs/sdk/node#name-send-a-typing-state-to-receipts-129)
-   [Listening to receipts](/docs/sdk/node#name-listening-to-receipts-148)
-   [Listening to server receipt](/docs/sdk/node#name-listening-to-server-receipt-211)
-   [Listening to receipt of type received](/docs/sdk/node#name-listening-to-receipt-of-type-received-219)
-   [Listening to receipt of type read](/docs/sdk/node#name-listening-to-receipt-of-type-read-227)
-   [Supporting additionnal message content](/docs/sdk/node#name-supporting-additionnal-message-content-235)
-   [Message language](/docs/sdk/node#name-message-language-262)
-   [Additional content type and message](/docs/sdk/node#name-additional-content-type-and-message-276)
-   [Message Subject](/docs/sdk/node#name-message-subject-297)
-   [Interaction with Rainbow clients](/docs/sdk/node#name-interaction-with-rainbow-clients-308)
-   [Specific Bubbles messages](/docs/sdk/node#name-specific-bubbles-messages-364)
-   [Limits](/docs/sdk/node#name-limits-431)

...
description: ""
type: "sdk"
source: "https://developers.openrainbow.com/doc/sdk/node/lts/guides/Managing_channels"
lastSynced: "2026-02-20T07:12:33.134Z"
---
# Documentation
...
The text message to send. This field is **mandatory**
...
An link to a file or web site can be added
...
-   [Managing Channels](/docs/sdk/node#name-managing-channels-0)
-   [Preamble](/docs/sdk/node#name-preamble-4)
-   [Retrieving the list of existing channels](/docs/sdk/node#name-retrieving-the-list-of-existing-channels-96)
-   [Retrieve a channel information by its id](/docs/sdk/node#name-retrieve-a-channel-information-by-its-id-113)
-   [Creating channels](/docs/sdk/node#name-creating-channels-124)
-   [Creating a new private channel](/docs/sdk/node#name-creating-a-new-private-channel-131)
-   [Creating a new public channel](/docs/sdk/node#name-creating-a-new-public-channel-139)
-   [Updating a channel](/docs/sdk/node#name-updating-a-channel-150)
-   [Adding and removing users in private channel](/docs/sdk/node#name-adding-and-removing-users-in-private-channel-158)
-   [Adding new members to a private channel](/docs/sdk/node#name-adding-new-members-to-a-private-channel-168)
-   [Adding new publishers to a private channel](/docs/sdk/node#name-adding-new-publishers-to-a-private-channel-176)
-   [Adding new owners to a private channel](/docs/sdk/node#name-adding-new-owners-to-a-private-channel-184)
-   [Updating users in a private channel](/docs/sdk/node#name-updating-users-in-a-private-channel-192)
-   [Removing users from a private channel](/docs/sdk/node#name-removing-users-from-a-private-channel-199)
-   [Getting all users from a channel](/docs/sdk/node#name-getting-all-users-from-a-channel-211)
-   [Sending messages to channel](/docs/sdk/node#name-sending-messages-to-channel-236)
-   [Listening to message from a channel](/docs/sdk/node#name-listening-to-message-from-a-channel-300)
-   [Searching for a public channel](/docs/sdk/node#name-searching-for-a-public-channel-312)
-   [Subscribing to a public channel](/docs/sdk/node#name-subscribing-to-a-public-channel-326)
-   [Unsubscribing from a public channel](/docs/sdk/node#name-unsubscribing-from-a-public-channel-337)
-   [Deleting a channel](/docs/sdk/node#name-deleting-a-channel-345)
-   [Limits](/docs/sdk/node#name-limits-356)
